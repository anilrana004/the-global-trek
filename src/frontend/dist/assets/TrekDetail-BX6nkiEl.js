import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, L as Link, b as MessageCircle, u as useComposedRefs, R as React, d as cn, e as commonjsGlobal, g as getDefaultExportFromCjs, f as clsx, i as invariant, a as Mountain, X, P as Phone, h as useParams } from "./index-BO08U1_a.js";
...
import { u as useControllableState, P as Primitive, a as useId, c as composeEventHandlers, b as createContextScope, d as useLayoutEffect2 } from "./index-C_KHevwb.js";
import { c as createCollection, u as useDirection } from "./index-8WvI_qVX.js";
import { P as Presence } from "./index-CrJLQX1U.js";
import { C as ChevronDown } from "./chevron-down-Qav0GsRp.js";
...
import { T as TrendingUp } from "./trending-up-CrXvHsDl.js";
...
function StickyBookingWidget({
  ...
  const badge = selectedBatch ? batchStatusBadge(selectedBatch.status, selectedBatch.availableSeats) : null;
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          style: { background: badge.bg, color: badge.color },
                          children: batch.status === "sold_out" ? "FULL" : badge.label
                        }
                      ) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "td",
...
function ReviewsSection({ trek }) {
  var _a, _b;
  const reviews = ((_a = trek.detailedReviews) == null ? void 0 : _a.length) ? trek.detailedReviews : SAMPLE_REVIEWS;
  ...
  const avgRating = (reviews.reduce((s2, r) => s2 + r.rating, 0) / reviews.length).toFixed(1);
  const dimLabels = [
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: filtered.slice(0, 4).map((review, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "bg-white rounded-2xl p-5 shadow-sm border",
                style: { borderColor: "rgba(26,122,76,0.12)" },
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 leading-relaxed", children: review.comment }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: Object.entries(review.dimensions).slice(0, 3).map(([k2, v2]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
