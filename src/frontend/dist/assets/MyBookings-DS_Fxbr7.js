import { j as jsxRuntimeExports, L as Link, B as Button, r as reactExports, m as motion, M as MapPin, b as MessageCircle } from "./index-vYOW-QfD.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent, R as ReviewSubmissionForm } from "./tabs-MdzXxiip.js";
...
function getTrekSlug(trekName) {
  return trekName.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "");
}
...
function BookingCard({
  ...
  const [alreadyReviewed, setAlreadyReviewed] = reactExports.useState(
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-border flex flex-wrap gap-2", children: variant === "upcoming" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          alreadyReviewed ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-3 h-3", fill: "#F4A623", color: "#F4A623" }),
                "Review Submitted"
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
