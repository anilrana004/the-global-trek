import { r as reactExports, e as useActor, j as jsxRuntimeExports, m as motion, L as Link, f as createActor } from "./index-vYOW-QfD.js";
...
function BlogPage() {
  ...
  const [canisterPosts, setCanisterPosts] = reactExports.useState([]);
  reactExports.useEffect(() => {
    if (!actor || isFetching) return;
    actor.getPublishedAdminBlogPosts().then((posts) => setCanisterPosts(posts)).catch(() => {
    });
  }, [actor, isFetching]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", "data-ocid": "blog.page", children: [
    ...
    canisterPosts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-7 rounded-full bg-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Latest from Our Team" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: canisterPosts.slice(0, 6).map((post, i) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.article,
              {
                ...
                children: [
                  post.heroImageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col flex-1", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed line-clamp-2 flex-1", children: post.excerpt }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-border flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground leading-none", children: post.author }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1 text-[10px] text-muted-foreground font-mono mt-0.5", children: [
