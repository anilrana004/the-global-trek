import { c as createLucideIcon, e as useActor, r as reactExports, f as createActor, h as useLanguage, j as jsxRuntimeExports, B as Button, A as AnimatePresence, m as motion, L as Link, b as MessageCircle, u as useComposedRefs, o, d as cn, i as commonjsGlobal, k as getDefaultExportFromCjs, l as clsx, n as invariant, a as Mountain, C as Check, X, p as useQuery, q as useQueryClient, s as useMutation, P as Phone, t as useParams } from "./index-vYOW-QfD.js";
import { t as treksData } from "./treks-DnGP1pKS.js";
import { I as Input } from "./input-CgB5bWX1.js";
import { L as Label$1 } from "./label-D7RL7BJP.js";
import { S as Star } from "./star-BLOO0ZgP.js";
import { S as Shield } from "./shield-DctcqSRy.js";
import { u as useControllableState, P as Primitive, c as composeEventHandlers, a as createContextScope, b as useLayoutEffect2 } from "./index-Gp0GX1_L.js";
...
import { R as ReviewSubmissionForm, T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-MdzXxiip.js";
/**
...
function useSeatAvailability(trekSlug, batchDate) {
  const { actor, isFetching } = useActor(createActor);
  const [available, setAvailable] = reactExports.useState(15);
  const [total, setTotal] = reactExports.useState(15);
  const [recentViewers, setRecentViewers] = reactExports.useState(0);
  const [isLoading, setIsLoading] = reactExports.useState(true);
  const pageViewRecorded = reactExports.useRef(false);
  const seatIntervalRef = reactExports.useRef(null);
  const viewerIntervalRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    ...
    fetchSeats();
    fetchViewers();
    seatIntervalRef.current = setInterval(fetchSeats, 3e4);
    viewerIntervalRef.current = setInterval(fetchViewers, 6e4);
    return () => {
...
function WaitlistModal({
  ...
  const handleSubmit = async (e3) => {
    ...
    setError("");
    try {
      const input = { name, email, phone, trekSlug, batchDate };
      const result = await actor.joinWaitlist(input);
      setPosition(result);
    } catch {
      setError(t2("common_error"));
    } finally {
      setSubmitting(false);
    }
  };
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-start justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-gray-900", children: "Join the Waitlist" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-gray-500", children: waitlistCount > 0 ? `${waitlistCount} others already on waitlist` : "Be first on the waitlist" })
              ] }),
            ...
            position ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-green-50 p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl", children: "🎉" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 font-semibold text-green-800", children: "You're on the waitlist!" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-green-600", children: "We'll notify you by email if a seat opens up." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "wl-name", children: "Full Name" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "wl-name",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "wl-email", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "wl-email",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "wl-phone", children: "Phone / WhatsApp" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "wl-phone",
                    value: phone,
                    onChange: (e3) => setPhone(e3.target.value),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: submitting ? "Joining..." : t2("trek_join_waitlist")
                }
              )
            ] })
          ]
...
function SeatCounter({
  ...
  const { available, total, isLow, isFull, recentViewers, isLoading } = useSeatAvailability(trekSlug, batchDate);
  ...
  const colorClass = isFull ? "text-red-600" : available <= 3 ? "text-red-500" : available <= 8 ? "text-amber-500" : "text-green-600";
  const dotColor = isFull ? "bg-red-500" : available <= 3 ? "bg-red-400" : available <= 8 ? "bg-amber-400" : "bg-green-500";
  const capacityPct = total > 0 ? Math.round((total - available) / total * 100) : 0;
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "span",
      {
        ...
        children: [
          ...
          isFull ? t2("trek_sold_out") : `${available} ${t2("trek_seats_left")}`
        ]
      }
    );
  }
  if (variant === "calendar") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 flex-1 rounded-full bg-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-medium ${colorClass}`, children: isFull ? t2("trek_sold_out") : `${available}/${total}` })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          isFull ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-red-600", children: "SOLD OUT" }),
            waitlistCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-0.5 text-xs text-gray-500", children: [
              waitlistCount,
              " on waitlist"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: t2("trek_join_waitlist")
              }
            )
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: isLow ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-sm font-bold ${colorClass}`, children: [
                    t2("trek_almost_full"),
                    "! Only ",
                    available,
                    " seats remain"
              ...
              motion.div,
              {
                ...
                className: "flex items-center gap-2",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `h-2 w-2 rounded-full ${dotColor}` }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `text-sm font-semibold ${colorClass}`, children: [
                    "⚡ ",
                    available,
                    " of ",
                    total,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 h-1.5 w-full rounded-full bg-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
          ...
          recentViewers > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-center text-xs text-gray-500", children: [
            "👁 ",
            recentViewers,
            " ",
            t2("seat_counter_viewing")
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showWaitlist && /* @__PURE__ */ jsxRuntimeExports.jsx(
      WaitlistModal,
      {
        trekSlug,
        batchDate,
...
function difficultyColor(d2) {
  const l2 = d2.toLowerCase();
  if (l2.includes("easy") && !l2.includes("moderate")) return "#16a34a";
  if (l2.includes("moderate") && !l2.includes("difficult")) return "#d97706";
  return "#dc2626";
}
function altitudeAmsLevel(altM) {
  if (!altM || altM < 3e3) return "low";
  if (altM < 4500) return "moderate";
  return "high";
}
function parseAltM(maxAlt) {
...
function generateBatches(trekId, price) {
...
function batchStatusBadge(status, seats) {
  if (status === "sold_out")
...
const GT_GREEN$2 = "#1A7A4C";
const GT_DARK$2 = "#145C38";
const GT_AMBER$2 = "#F4A623";
function StickyBookingWidget({
  ...
  const available = batches.filter(
    (b2) => b2.status !== "sold_out" && b2.status !== "waitlist"
  );
  const [selectedBatch, setSelectedBatch] = reactExports.useState(
    available[0] ?? null
  );
  const [participants, setParticipants] = reactExports.useState(2);
  const batchPrice = (selectedBatch == null ? void 0 : selectedBatch.price) ?? price;
  ...
  selectedBatch ? batchStatusBadge(selectedBatch.status, selectedBatch.availableSeats) : null;
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", style: { background: GT_DARK$2 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/70 text-sm mb-0.5", children: "/person" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-1", children: [
                [1, 2, 3, 4, 5].map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Star,
                  {
                    className: "w-3 h-3",
                    style: {
                      fill: s2 <= Math.round(trek.rating ?? 4.9) ? GT_AMBER$2 : "transparent",
                      color: GT_AMBER$2
                    }
                  },
                  `ws-${s2}`
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "select",
                  {
                    ...
                    value: (selectedBatch == null ? void 0 : selectedBatch.id) ?? "",
                    onChange: (e3) => setSelectedBatch(
                      available.find((b2) => b2.id === e3.target.value) ?? null
                    ),
                    className: "w-full text-sm rounded-lg px-3 py-2 border focus:outline-none focus:ring-2",
                    style: {
                      borderColor: `${GT_GREEN$2}40`,
                      background: "#f9fafb"
                    },
                    "data-ocid": "trek_booking_widget.batch_select",
                    children: available.map((b2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: b2.id, children: [
                      formatDate(b2.startDate),
                      " – ",
                      b2.availableSeats,
                      " seats"
                    ] }, `opt-${b2.id}`))
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    trekSlug: slug,
                    batchDate: (selectedBatch == null ? void 0 : selectedBatch.startDate) ?? "",
                    variant: "sidebar"
                  }
                ) })
              ] }),
                  ...
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          type: "button",
                          onClick: () => setParticipants((p2) => Math.min(15, p2 + 1)),
                          className: "w-8 h-8 rounded-full flex items-center justify-center font-bold text-white transition-all hover:opacity-80",
                          style: { background: GT_GREEN$2 },
                      ...
                      participants >= 6 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          style: { color: GT_GREEN$2 },
                          children: "10% group discount!"
                        }
                      )
                    ]
                  }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    groupDiscount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        style: { color: GT_DARK$2, borderColor: "#e5e7eb" },
                        children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  style: { background: GT_AMBER$2, color: "#0A2E1A" },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1 pt-1", children: [
                {
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-3.5 h-3.5" }),
                  label: "Secure Pay"
                },
                {
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "📧" }),
              ...
              ].map((tb) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex flex-col items-center gap-0.5 text-center",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: GT_GREEN$2 }, children: tb.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
...
var AccordionImplSingle = o.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      AccordionValueProvider,
      {
        ...
        value: o.useMemo(() => value ? [value] : [], [value]),
        onItemOpen: setValue,
        onItemClose: o.useCallback(() => collapsible && setValue(""), [collapsible, setValue]),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionImpl, { ...accordionSingleProps, ref: forwardedRef }) })
      }
    );
  }
);
var AccordionImplMultiple = o.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleItemOpen = o.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleItemClose = o.useCallback(
...
var AccordionImpl = o.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAccordion, disabled, dir, orientation = "vertical", ...accordionProps } = props;
    const accordionRef = o.useRef(null);
...
var AccordionItem$1 = o.forwardRef(
  (props, forwardedRef) => {
...
var AccordionHeader = o.forwardRef(
  (props, forwardedRef) => {
...
var AccordionTrigger$1 = o.forwardRef(
  (props, forwardedRef) => {
...
var AccordionContent$1 = o.forwardRef(
  (props, forwardedRef) => {
...
const GT_GREEN$1 = "#1A7A4C";
const GT_DARK$1 = "#145C38";
const GT_AMBER$1 = "#F4A623";
const GT_HERO_BG = "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.72) 100%)";
...
function TrekHero({ trek }) {
  ...
  reactExports.useEffect(() => {
    ...
    if (wishlisted) {
      ...
      localStorage.setItem(
        WISHLIST_KEY,
        JSON.stringify(list.filter((s2) => s2 !== slug))
      );
    }
  }, [wishlisted, slug]);
  ...
  const heroImage = ((_a = trek.heroImages) == null ? void 0 : _a[0]) ?? `https://source.unsplash.com/1600x900/?${trek.imageQuery ?? trek.name.toLowerCase().replace(/ /g, ",")},himalaya,trek`;
  const photoImages = ((_b = trek.images) == null ? void 0 : _b.slice(0, 5)) ?? Array.from(
    { length: 5 },
    (_, i) => `https://source.unsplash.com/400x300/?${trek.imageQuery ?? "himalaya,trek"},${i + 1}`
  );
  const rotations = [-3, 1.5, -2, 3, -1];
  const stateLabel = trek.state === "Himachal Pradesh" ? "Himachal Pradesh" : "Uttarakhand";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0", style: { background: GT_HERO_BG } })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-6 right-6 flex gap-2 z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex flex-col items-center justify-center text-center px-6 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "nav",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/treks", className: "hover:text-white transition-colors", children: "Treks" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "/" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: trek.state === "Himachal Pradesh" ? "/treks/himachal-pradesh" : "/treks/uttarakhand",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            style: { borderColor: GT_AMBER$1, color: GT_AMBER$1 },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: { height: "180px" },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end justify-center gap-3 px-6 pb-4 h-full", children: photoImages.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: typeof src === "string" && src.startsWith("http") ? src : `https://source.unsplash.com/400x300/?${trek.imageQuery ?? "himalaya,trek"},${i + 2}`,
...
function QuickFactsStrip({
  ...
  const diffBars = [
    {
      ...
      value: trek.difficulty.toLowerCase().includes("difficult") ? 4 : trek.difficulty.toLowerCase().includes("moderate") ? 3 : 2
    },
    {
  ...
  const facts = [
    ...
    {
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: "₹" }),
      label: "From",
      value: trek.price
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        background: isSticky ? "rgba(255,255,255,0.95)" : "rgba(255,255,255,0.98)",
        backdropFilter: "blur(12px)",
        borderBottom: "1px solid rgba(26,122,76,0.15)",
        boxShadow: isSticky ? "0 4px 20px rgba(0,0,0,0.12)" : "0 2px 8px rgba(0,0,0,0.06)"
      },
      "data-ocid": "trek_quick_facts.strip",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 py-4", children: facts.map((f2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: GT_GREEN$1 }, children: f2.icon }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: {
                    color: f2.colored ? difficultyColor(trek.difficulty) : GT_DARK$1
                  },
                  children: f2.value
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-4 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: amsConfig.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: amsConfig.label })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: diffBars.map((bar) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-center gap-2",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-500 whitespace-nowrap", children: [
                  bar.label,
                  ":"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: i <= bar.value ? GT_GREEN$1 : "#e5e7eb"
                    }
                  },
                  `db-${bar.label}-${i}`
                )) }),
...
function TrekOverview({ trek }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-8", children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: storyText.split("\n\n").map((para) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: para }, para.slice(0, 30)))
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3", children: sees.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl mb-1", children: cat.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "text-xs font-bold mb-1",
                      style: { color: GT_GREEN$1 },
                      children: cat.label
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "text-xs text-gray-600 space-y-0.5", children: cat.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, `see-item-${cat.label}-${item}`)) })
                ]
              },
              `see-${cat.label}`
            )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { background: GT_DARK$1 },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-4 border-b border-white/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 space-y-3", children: highlights.map((h2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          style: { background: GT_AMBER$1 },
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3 h-3 text-white" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/90 text-sm", children: h2 })
                    ]
                  },
                  `hl-${trek.id}-${i}`
                )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-sm", style: { color: GT_DARK$1 }, children: "At a Glance" }),
                [
                ...
                ].map(([k2, v2]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: k2 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-gray-800", children: v2 })
                ] }, `stat-${k2}`))
              ]
            }
          )
...
function TrekItinerary({ trek }) {
  const chartData = trek.itinerary.map((day) => ({
    name: `Day ${day.day}`,
    altitude: day.maxAltitude ?? (day.endAltitude ? Math.round(day.endAltitude * 0.3048) : 0),
    label: day.title
  }));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.h2,
          {
            ...
            style: { fontFamily: "'Playfair Display', serif", color: GT_DARK$1 },
            children: "Day-by-Day Itinerary"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-gray-500 mb-8 text-sm", children: "Detailed day-wise plan with meals, campsites & emergency info" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "multiple", className: "space-y-3 mb-12", children: trek.itinerary.map((day, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          AccordionItem,
          {
            value: `day-${day.day}`,
            className: "bg-white rounded-2xl overflow-hidden shadow-sm border",
            style: {
              borderColor: day.day === 4 || day.highlights.some((h2) => h2.toLowerCase().includes("summit")) ? GT_AMBER$1 : "rgba(26,122,76,0.1)"
            },
            "data-ocid": `trek_itinerary.day.${idx + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-5 py-4 hover:no-underline [&>svg]:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 w-full text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gray-800", children: day.title }),
                    day.highlights.some(
                      (h2) => h2.toLowerCase().includes("summit")
                    ) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-1 text-xs text-gray-500 flex-wrap", children: [
                    day.maxAltitude && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Mountain, { className: "w-3 h-3" }),
                      " ",
                      day.maxAltitude,
                      "ft"
                    ] }),
                    day.distanceKm && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                      day.distanceKm,
                      " km"
                    ] }),
                    day.walkingHours && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3 inline" }),
                      " ",
                      day.walkingHours,
                      "h walking"
                    ] }),
                    day.difficulty && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize", children: day.dayDifficulty ?? day.difficulty })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-5 h-5 text-gray-400 shrink-0 transition-transform duration-200 group-data-[state=open]:rotate-180" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 pt-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 leading-relaxed text-sm", children: day.description }),
                  day.terrain && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gray-600", children: "Terrain:" }),
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: day.terrain })
                  ] }),
                  day.highlights.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-gray-700 mb-1", children: "Highlights:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: day.highlights.map((h2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "li",
                      {
                  ...
                  day.photographyHighlights && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-gray-700 mb-1", children: "📷 Photo Spots:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: day.photographyHighlights.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "li",
                      {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-gray-600 space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Breakfast:" }),
                            " ",
                            day.mealDetail.breakfast
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Lunch:" }),
                            " ",
                            day.mealDetail.lunch
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Dinner:" }),
                            " ",
                  ...
                  day.campsite && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-600 mb-1", children: [
                          day.campsite.altitude,
                          " ft altitude"
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: day.campsite.amenities.map((a2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                  ...
                  day.emergencyExit && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 flex items-start gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3 mt-0.5 flex-shrink-0 text-amber-500" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Emergency exit:" }),
                      " ",
                      day.emergencyExit
                    ] })
                  ] }),
          ...
          `itinerary-day-${trek.id}-${day.day}`
        )) }),
        chartData.some((d2) => d2.altitude > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "linearGradient",
                      {
                        ...
                        y2: "1",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: GT_GREEN$1, stopOpacity: 0.3 }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "stop",
                            {
                              offset: "95%",
                              stopColor: GT_GREEN$1,
                              stopOpacity: 0.02
                            }
                          )
                        ]
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#f0fdf4" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      XAxis,
                      {
                        dataKey: "name",
...
function BatchesAndPricing({ trek }) {
  const slug = trek.slug ?? trek.id;
  const price = trek.priceMin ?? 8500;
  const batches = trek.batchSlots ?? generateBatches(trek.id, price);
  const [selectedMonth, setSelectedMonth] = reactExports.useState(null);
  const months = [
    ...new Set(batches.map((b2) => new Date(b2.startDate).getMonth() + 1))
  ];
  const filtered = selectedMonth ? batches.filter(
    (b2) => new Date(b2.startDate).getMonth() + 1 === selectedMonth
  ) : batches;
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.h2,
          {
            ...
            style: { fontFamily: "'Playfair Display', serif", color: GT_DARK$1 },
            children: "Upcoming Batches & Pricing"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 mb-8 text-sm", children: "All prices include transport, meals, accommodation, permits & guide fees" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                background: !selectedMonth ? GT_GREEN$1 : "#f0fdf4",
                color: !selectedMonth ? "white" : GT_DARK$1,
                border: `1px solid ${GT_GREEN$1}40`
              },
              "data-ocid": "trek_batches.all_months_filter",
              children: "All Months"
            }
          ),
          months.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setSelectedMonth(m2 === selectedMonth ? null : m2),
              className: "px-4 py-1.5 rounded-full text-sm font-medium transition-all",
              style: {
                background: selectedMonth === m2 ? GT_GREEN$1 : "#f0fdf4",
                color: selectedMonth === m2 ? "white" : GT_DARK$1,
                border: `1px solid ${GT_GREEN$1}40`
              },
              "data-ocid": `trek_batches.month_filter.${m2}`,
              children: [
                "Jan",
                "Feb",
                "Mar",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { style: { background: GT_DARK$1, color: "white" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: ["Dates", "Duration", "Type", "Seats", "Price", ""].map((h2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "th",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filtered.map((batch, i) => {
                batchStatusBadge(
                  batch.status,
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "tr",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-gray-600", children: "5 Days / 4 Nights" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "px-2 py-0.5 rounded-full text-xs font-semibold",
                          style: { background: "#f0fdf4", color: GT_GREEN$1 },
                          children: "Regular"
                        }
                      ) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: batch.status === "sold_out" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "Sold Out" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Link,
                        {
                          to: `/booking/${slug}/select-batch`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 text-sm", children: trek.inclusions.slice(0, 6).map((inc) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Check,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: inc })
                ] }, `inc-price-${inc}`)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-gray-200", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "Base price (1 person)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: trek.price })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm mt-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: "GST (5%)" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: { color: GT_DARK$1 },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Total (per person)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                          "₹",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                ].map(([timing, refund]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "flex justify-between py-1.5 border-b border-red-100",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: timing }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "font-semibold",
                          style: {
                            color: refund.includes("No") ? "#dc2626" : refund.includes("80") ? "#16a34a" : "#d97706"
                          },
                          children: refund
                        }
                      )
...
function InclusionsExclusions({ trek }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      className: "py-12",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: trek.inclusions.map((inc) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Check,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700", children: inc })
                ] }, `inc-${inc}`)) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "flex items-center gap-2 font-bold text-lg mb-4 text-red-700", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5" }),
                    " Not Included"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: trek.exclusions.map((exc) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-3.5 h-3.5 mt-0.5 flex-shrink-0 text-red-400" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-600", children: exc })
                  ] }, `exc-${exc}`)) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold mb-2", style: { color: "#92400e" }, children: "🐴 Porter & Mule Service" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-gray-600 space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                      "Personal porter (up to 10 kg): ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "₹800/day" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                      "Mule for duffel bag: ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "₹600/day" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Must be booked 5 days before departure" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      to: `/booking/${trek.slug ?? trek.id}/select-batch`,
                      className: "inline-block mt-3 text-xs font-semibold px-3 py-1.5 rounded-full",
                      style: { background: GT_AMBER$1, color: "#0A2E1A" },
                      "data-ocid": "trek_inclusions.add_porter_button",
                      children: "Add Porter to Booking"
                    }
                  )
                ]
              }
...
function toFrontendReview(r) {
  const date2 = r.trekDate ?? (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
  const dateObj = new Date(date2);
  const monthNum = Number.isNaN(dateObj.getMonth()) ? 1 : dateObj.getMonth() + 1;
  ...
  return {
    ...
    tripYear: dateObj.getFullYear() || (/* @__PURE__ */ new Date()).getFullYear(),
...
function useApprovedReviews(trekSlug) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useAggregateRating(trekSlug) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function Stars({ n: n2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex gap-0.5", children: [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Star,
    {
      ...
      fill: i < Math.round(n2) ? "#f59e0b" : "none",
      color: i < Math.round(n2) ? "#f59e0b" : "#71717a"
    },
    `star-${i}`
  )) });
}
function DimBar({ label, val }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 w-28 flex-shrink-0", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 bg-gray-100 rounded-full h-1.5 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold w-4", style: { color: GT_DARK }, children: val })
  ] });
}
function SafetyAndFitness({ trek }) {
  var _a;
  const weather = [
    {
      month: "Dec",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.h2,
          {
            ...
            children: "Safety, Fitness & AMS Protocol"
          }
        ),
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-4", children: [
                  ...
                  `Age ${((_a = trek.quickFacts) == null ? void 0 : _a.minAge) ?? 14}+ (below with parent, case-by-case)`,
                  "No major cardiac or respiratory conditions",
                  "BMI under 35 recommended"
                ].map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Check,
                    {
                      className: "w-4 h-4 mt-0.5 flex-shrink-0",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: r })
                ] }, `fit-${r}`)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 border-t border-gray-200", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      style: { color: GT_DARK },
                      children: "8-Week Preparation Plan:"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-xs text-gray-600 space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Weeks 1–2: 5 km brisk walk daily" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Weeks 3–4: Add 10-floor stair climbing, 3×/day" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Weeks 5–6: 8–10 km weekend hikes" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Weeks 7–8: Full-pack hike (10 kg), hill training" })
                  ] })
                ] })
              ]
            }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "h3",
                  {
                    ...
                    children: [
                      ...
                      " AMS & Altitude Safety Protocol"
                    ]
                  }
                ),
                sp ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { type: "multiple", className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "prevention", className: "border-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      AccordionTrigger,
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-xs text-gray-600 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 list-disc list-inside", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                        "Night 1 at ",
                        trek.startPoint,
                        " for acclimatization"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Ascent rate never exceeds 600m/day above 2,500m" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: '"Climb high, sleep low" principle followed' }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Minimum 3 litres water/day enforced" })
                    ] }) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "monitoring", className: "border-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      AccordionTrigger,
                      {
                        className: "text-sm font-semibold py-2 hover:no-underline",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "text-xs text-gray-600 pb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Pulse oximeter readings every morning. SpO2 < 85% = immediate rest day at lower altitude." }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "emergency", className: "border-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      AccordionTrigger,
                      {
                        className: "text-sm font-semibold py-2 hover:no-underline",
                        style: { color: GT_DARK },
                        children: "Emergency Evacuation"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "text-xs text-gray-600 pb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: sp.evacuationProcedure }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1", children: [
                        "Helipad: ",
                        sp.helicopterLandingZone.location
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1", children: [
                        "Nearest hospital: ",
                        sp.nearestHospital.name,
                        " (",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• Satellite phone (Garmin InReach) carried at all times" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• Portable oxygen cylinders at every camp" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• Pulse oximeter: mandatory morning checks" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• SpO2 < 85% → immediate descent protocol" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "• Emergency evacuation via helicopter (Sankri LZ)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                    "• 24/7 emergency: ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "+91-9876543210" })
                  ] })
                ] })
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { borderColor: "rgba(26,122,76,0.1)" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-4", style: { background: GT_DARK }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-white", children: "Typical Weather by Month" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "#f0fdf4" }, children: ["Month", "Day Temp", "Night Temp", "Snow", "Risk"].map(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: weather.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "tr",
                  {
                    className: "border-b",
                    style: {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-gray-600", children: row.day }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-gray-600", children: row.night }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-gray-600", children: row.snow }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "px-2 py-0.5 rounded-full text-xs font-semibold",
                          style: {
                            background: row.risk === "Very Low" ? "#f0fdf4" : row.risk === "Low" ? "#f0fdf4" : row.risk === "Moderate" ? "#fffbeb" : "#fef2f2",
                            color: row.risk === "Very Low" ? "#16a34a" : row.risk === "Low" ? "#15803d" : row.risk === "Moderate" ? "#d97706" : "#dc2626"
                          },
                          children: row.risk
                        }
                      ) })
...
function GearAndPacking({ trek }) {
  ...
  const totalItems = categories.flatMap((c2) => c2.items).length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.h2,
            {
              ...
              style: { fontFamily: "'Playfair Display', serif", color: GT_DARK },
              children: "Gear & Packing List"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", style: { color: GT_DARK }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-bold mb-3 flex items-center gap-2", children: [
                ...
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: GT_DARK }, children: cat.name })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: cat.items.map((item) => {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          checked: !!checked[key],
                          onChange: (e3) => setChecked((prev) => ({
                            ...prev,
                            [key]: e3.target.checked
                          })),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
              className: "text-xl font-bold mb-4",
              style: { fontFamily: "'Playfair Display', serif", color: GT_DARK },
              children: "Gear Rental"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3", children: GEAR_RENTALS.map((gear) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-2", children: gear.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-xs font-bold mb-1",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mb-1", children: gear.desc }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "p",
                  {
                    className: "text-xs font-semibold",
...
function ReviewsSection({ trek }) {
  ...
  const { data: liveReviews, isLoading: reviewsLoading } = useApprovedReviews(trekSlug);
  const { data: aggregate } = useAggregateRating(trekSlug);
  const upvoteMutation = useUpvoteReview();
  const reviews = liveReviews && liveReviews.length > 0 ? liveReviews : ((_a = trek.detailedReviews) == null ? void 0 : _a.length) ? trek.detailedReviews : SAMPLE_REVIEWS;
  const [filterRating, setFilterRating] = reactExports.useState(null);
  const [filterGroup, setFilterGroup] = reactExports.useState(null);
  const [filterMonth, _setFilterMonth] = reactExports.useState(null);
  const [showReviewForm, setShowReviewForm] = reactExports.useState(false);
  const [localHelpful, setLocalHelpful] = reactExports.useState({});
  ...
  const avgRating = (aggregate == null ? void 0 : aggregate.avg) ? aggregate.avg.toFixed(1) : reviews.length > 0 ? (reviews.reduce((s2, r) => s2 + r.rating, 0) / reviews.length).toFixed(1) : "0.0";
  const reviewCount = (aggregate == null ? void 0 : aggregate.count) ?? reviews.length;
  const dimLabels = [
  ...
  for (const [key] of dimLabels) {
    dimAvgs[key] = Number.parseFloat(
      (reviews.reduce((s2, r) => s2 + r.dimensions[key], 0) / reviews.length).toFixed(1)
    );
  }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.h2,
            {
              ...
              className: "text-3xl font-bold",
              style: { fontFamily: "'Playfair Display', serif", color: GT_DARK },
              children: "Trekker Reviews & Community"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center my-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Stars, { n: Number.parseFloat(avgRating) }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 space-y-2", children: dimLabels.map(([key, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              DimBar,
              {
                label,
                val: dimAvgs[key] ?? 0
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-4", children: [
              [5, 4, 3].map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
              ...
              ["solo", "couple", "family", "corporate"].map((g2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => setFilterGroup(filterGroup === g2 ? null : g2),
                  className: "px-3 py-1 rounded-full text-xs font-semibold capitalize transition-all",
                  style: {
                    background: filterGroup === g2 ? GT_GREEN : "#f0fdf4",
                    color: filterGroup === g2 ? "white" : GT_DARK,
                    border: `1px solid ${GT_GREEN}40`
                  },
                  "data-ocid": `trek_reviews.filter_group.${g2}`,
                  children: g2
                },
                `filter-group-${g2}`
              ))
            ] }),
            reviewsLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "trek_reviews.loading_state", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-gray-200" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 bg-gray-200 rounded w-1/3" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-gray-100 rounded w-1/4" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-gray-100 rounded w-full" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-gray-100 rounded w-4/5" })
                  ] })
                ]
              },
              `skel-${i}`
            )) }),
            !reviewsLoading && filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                    {
                      ...
                      children: "Be the first to review this trek!"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 mb-4", children: "Share your experience and help future trekkers plan their adventure." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
            ...
            !reviewsLoading && filtered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: filtered.slice(0, 5).map((review, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "bg-white rounded-2xl p-5 shadow-sm border",
                style: { borderColor: "rgba(26,122,76,0.12)" },
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gray-800", children: review.author }),
                          review.reviewerCity && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-xs text-gray-400", children: review.reviewerCity }),
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Stars, { n: review.rating })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-0.5 text-xs text-gray-500", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: review.groupType
                          }
                        )
                      ] })
                    ] })
                  ] }),
                  review.title && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h4",
                    {
                      className: "font-semibold text-sm mb-1",
                      style: { color: GT_DARK },
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 leading-relaxed", children: review.comment || review.reviewText || "" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-2", children: Object.entries(review.dimensions).filter(([, v2]) => v2 > 0).slice(0, 4).map(([k2, v2]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      className: "text-xs px-2 py-0.5 rounded-full",
                      style: { background: "#f0fdf4", color: GT_DARK },
                      children: [
                        k2 === "guideExpertise" ? "Guide" : k2 === "valueForMoney" ? "Value" : k2.charAt(0).toUpperCase() + k2.slice(1),
                        ": ",
                        v2,
                        "/5"
                      ]
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      children: [
                        ...
                        review.helpful + (localHelpful[review.id] ? 1 : 0),
                        " found this helpful"
                      ]
                    }
                  ) }),
                  review.photos && review.photos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-3", children: review.photos.map((photo, pi2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: photo,
                      alt: `Trek snapshot ${pi2 + 1}`,
                      className: "w-16 h-16 object-cover rounded-lg border",
                      style: { borderColor: "rgba(26,122,76,0.15)" }
                    },
                    `rphoto-${review.id}-${pi2}`
                  )) })
                ]
              },
              `review-${review.id}`
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [
                ...
                },
                {
                  ...
                  a: `Yes, children ${((_b = trek.quickFacts) == null ? void 0 : _b.minAge) ?? 14}+ can participate. Kids 10–13 on a case-by-case basis with parental consent and medical clearance.`
                }
              ].map((qa) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
...
function LogisticsSection({ trek }) {
  const cities = [
    {
      label: "From Delhi",
      content: [
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.h2,
          {
            ...
            className: "text-3xl font-bold mb-8",
            style: { fontFamily: "'Playfair Display', serif", color: GT_DARK },
            children: "How to Reach & Stay"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "Delhi", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsList, { className: "flex flex-wrap h-auto gap-1 mb-4 bg-transparent p-0", children: cities.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              TabsTrigger,
              {
                value: c2.label.replace("From ", ""),
                className: "text-xs px-3 py-1.5 rounded-full",
                style: { fontFamily: "'DM Sans', sans-serif" },
                "data-ocid": `trek_logistics.city_tab.${c2.label.replace("From ", "").toLowerCase()}`,
                children: c2.label
              },
              `tab-${c2.label}`
            )) }),
            cities.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              TabsContent,
              {
                value: c2.label.replace("From ", ""),
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: { borderColor: "rgba(26,122,76,0.12)" },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: c2.content.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "li",
                        {
                          className: "flex items-start gap-2 text-sm",
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: GT_AMBER }, className: "mt-1", children: "•" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: line })
                          ]
                        },
                        `logistic-${c2.label}-${i}`
                      )) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-gray-100 text-xs text-gray-500", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Nearest Railhead:" }),
                        " ",
                        trek.nearestRailhead,
                        " ",
                        " |  ",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Nearest Airport:" }),
                        " ",
                        trek.nearestAirport
                      ] })
                    ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold", style: { color: GT_DARK }, children: "Pre-Trek Stay in Dehradun" }),
            hotels.map((h2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  ].map((ec) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "flex items-center justify-between text-xs",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: ec.label }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "a",
                          {
                            href: `tel:${ec.num}`,
...
function FaqsAndCerts({ trek }) {
  var _a;
  const faqs = ((_a = trek.faqs) == null ? void 0 : _a.length) ? trek.faqs : [
    {
    ...
    },
    {
      ...
      answer: "30+ days: 80% refund. 15–29 days: 50%. 7–14 days: 25%. Under 7 days: no refund. Weather cancellations: full credit note."
    },
    {
      question: "What fitness level is required?",
      answer: "Ability to walk 8–10 km/day at altitude. Start preparation 8 weeks before with daily 5km walks and stair climbing."
    },
    {
      question: "Is AMS a concern?",
      answer: `Max altitude is ${trek.maxAltitude}. AMS risk is ${trek.altitudeM && trek.altitudeM > 4500 ? "significant — medical screening required" : trek.altitudeM && trek.altitudeM > 3e3 ? "moderate — acclimatization day included" : "low — standard hydration suffices"}.`
    },
    {
      question: "Can I do this solo?",
      answer: "Absolutely. We form small groups of 6–15 trekkers, so solo trekkers join a like-minded group. No solo-only premium."
    },
    {
      question: "What is accommodation like?",
      answer: "4-season mountain tents (twin sharing) rated to -20°C at campsites. Guesthouse on first night."
    }
  ];
  const certs = [
    {
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "multiple", className: "space-y-2", children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              value: `faq-${i}`,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-5 pb-4 text-sm text-gray-600 leading-relaxed", children: faq.answer })
              ]
            },
            `faq-${trek.id}-${i}`
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: certs.map((cert) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl mb-1", children: cert.emoji }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold", style: { color: GT_DARK }, children: cert.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: cert.detail })
                ]
              },
              `cert-${cert.name}`
            )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold mb-2", style: { color: GT_DARK }, children: "🌱 Eco Commitments" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-xs text-gray-600 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "✅ Zero plastic policy on all treks" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "✅ Leave No Trace strictly enforced" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "✅ All waste carried back for disposal" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "✅ ₹50/trekker donated to reforestation fund" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "✅ 1 tree planted per booking" })
                ] })
              ]
            }
          )
...
function RouteIntelligence({ trek }) {
  const waypoints = trek.itinerary.map((day, i) => ({
    label: `Day ${day.day}`,
    sublabel: day.title.split("→")[day.title.includes("→") ? 1 : 0].trim().split(" ")[0],
    alt: day.maxAltitude ? `${day.maxAltitude}ft` : day.endAltitude ? `${day.endAltitude}ft` : "",
    x: 50 + i * (700 / Math.max(trek.itinerary.length - 1, 1)),
    highlight: day.highlights.some((h2) => h2.toLowerCase().includes("summit"))
  }));
  const svgW = 800;
  const svgH = 120;
  const pathD = waypoints.map((pt, i) => `${i === 0 ? "M" : "L"} ${pt.x} ${svgH * 0.5}`).join(" ");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      className: "py-12",
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-x-auto mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "svg",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "marker",
                        {
                          ...
                          refY: "2",
                          orient: "auto",
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "0 0, 6 2, 0 4", fill: GT_GREEN })
                        }
                      ) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "path",
                      ...
                      waypoints.map((pt) => /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "circle",
                          {
                            cx: pt.x,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    onClick: () => {
                      const content = trek.itinerary.map(
                        (d2) => `${d2.title} | Alt: ${d2.maxAltitude ?? d2.endAltitude ?? ""}ft | ${d2.distanceKm ?? ""}km`
                      ).join("\n");
                      const blob = new Blob([content], { type: "text/plain" });
                      const a2 = document.createElement("a");
                      a2.href = URL.createObjectURL(blob);
                      a2.download = `${trek.id}-route.gpx`;
                      a2.click();
                    },
                    className: "flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold text-white",
                    style: { background: GT_GREEN },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { background: "#f0fdf4" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 text-left text-xs font-semibold text-gray-600", children: "Day" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 text-left text-xs font-semibold text-gray-600", children: "Terrain" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 text-left text-xs font-semibold text-gray-600", children: "Distance" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2 text-left text-xs font-semibold text-gray-600", children: "Difficulty" })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: trek.itinerary.map((day, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "tr",
                      {
                        className: "border-b",
                        style: {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-gray-600 text-xs", children: day.terrain ?? "Mountain trail" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5 text-gray-600", children: day.distanceKm ? `${day.distanceKm} km` : "—" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: "text-xs px-2 py-0.5 rounded-full capitalize",
                              style: {
                                background: day.difficulty === "hard" || day.difficulty === "very_hard" ? "#fef2f2" : day.difficulty === "moderate" ? "#fffbeb" : "#f0fdf4",
                                color: day.difficulty === "hard" || day.difficulty === "very_hard" ? "#dc2626" : day.difficulty === "moderate" ? "#d97706" : "#16a34a"
                              },
                              children: day.dayDifficulty ?? day.difficulty ?? "Easy"
                            }
                          ) })
                        ]
                      },
...
function TrekDetail() {
  const { trekId } = useParams({ strict: false });
  const trek = treksData.find((t2) => t2.slug === trekId || t2.id === trekId);
  const heroRef = reactExports.useRef(null);
  const [widgetVisible, setWidgetVisible] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  if (!trek) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex flex-col items-center justify-center bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h1",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "The trek you're looking for doesn't exist or has been moved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: "/explore",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: heroRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrekHero, { trek }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(QuickFactsStrip, { trek, isSticky: false }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TrekOverview, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TrekItinerary, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RouteIntelligence, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BatchesAndPricing, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InclusionsExclusions, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SafetyAndFitness, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(GearAndPacking, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewsSection, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(LogisticsSection, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FaqsAndCerts, { trek }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StickyBookingWidget, { trek, visible: widgetVisible })
  ] });
}
export {
  TrekDetail as default
};
