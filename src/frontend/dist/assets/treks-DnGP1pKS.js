const treksData = [
    ...
    itinerary: [
      {
        ...
        difficulty: "easy",
        dayDifficulty: "Easy",
        terrain: "Mountain road through Devprayag, Rudraprayag confluence towns, Kedarnath Bird Sanctuary",
        ...
        mealDetail: {
          ...
          dinner: "Chopta camp dinner: Rajma chawal, roti, seasonal sabzi, halwa dessert",
        ...
        emergencyExit: "Return to Rishikesh via same road — AIIMS Rishikesh 190km",
        ...
        weatherPattern: "Clear mountain skies in Oct–Nov; possibility of afternoon showers in monsoon (Jul–Sep)",
        wildlife: [
          "Monal pheasant near Chopta",
          "Himalayan black bear signs",
          "Barking deer"
        ],
        culturalNotes: "Drive passes the Kedarnath Bird Sanctuary — habitat of 200+ bird species; Ukhimath is the winter seat of the Kedarnath deity",
        sunriseTime: "6:20 AM",
        sunsetTime: "6:45 PM"
      },
      {
        ...
        terrain: "Ancient stone-paved trail through dense rhododendron and oak forest; rocky exposed ridge above tree line; boulder scramble to summit",
        campsiteElevation: 8500,
        campsite: {
        ...
        mealDetail: {
          breakfast: "4 AM summit push: hot porridge, boiled eggs, dry fruits, chai",
          lunch: "Packed trail lunch at Tungnath or Chandrashila base — sandwiches, energy bars, nuts",
          dinner: "Celebratory camp dinner: Paneer makhani, jeera rice, roti, kheer dessert",
          snacks: "Chocolate, dates on summit push; hot soup at Tungnath tea stalls (May–Nov)"
        },
        waterSources: [
        ...
        emergencyExit: "Return to Chopta village on stone trail (1.5 hours from Tungnath); road to AIIMS Rishikesh 190km",
        photographyHighlights: [
        ...
        weatherPattern: "Summit clears 4–8 AM; afternoon clouds typical; −2°C at Chandrashila in winter; windchill possible on exposed ridge",
        wildlife: [
        ...
        culturalNotes: "Tungnath is the 3rd of the Panch Kedar, open May–Nov; the 8th-century stone temple is attributed to Adi Shankaracharya. Chandrashila is where Lord Rama is said to have meditated after the Lanka war. Winter deity moves to Ukhimath.",
        acclimatizationNotes: "Maximum altitude 13,123ft; no AMS risk for healthy individuals with gradual ascent. SpO2 checks before summit departure.",
      ...
      },
      {
        ...
        description: "Optional morning trek to Deoria Tal — emerald lake reflecting Chaukhamba massif. Drive back to Rishikesh.",
        ...
        difficulty: "easy",
        dayDifficulty: "Easy",
        terrain: "Gentle forest trail to Deoria Tal; mountain road descent to Rishikesh",
        ...
        mealDetail: {
          breakfast: "Chopta camp: Poha, banana, boiled eggs, chai before departure",
        ...
        weatherPattern: "Clear mornings at Deoria Tal; warmer at lower altitudes",
        wildlife: [
          "Himalayan black bear near Deoria Tal (rare)",
          "Barking deer",
          "Forest birds"
        ],
        culturalNotes: "Deoria Tal — mentioned in the Mahabharata as the lake where the Yaksha tested the Pandavas. The Chaukhamba reflection at dawn is a sacred sight.",
        sunriseTime: "6:20 AM",
        sunsetTime: "7:00 PM"
      }
    ],
    ...
    faqs: [
      {
        ...
        answer: "Yes — one of India's most beginner-friendly high-altitude treks. The stone path to Tungnath is well-maintained."
      },
      {
        question: "Can I visit Tungnath Temple in winter?",
        answer: "The temple is open May to November. In winter it shifts to Ukhimath village."
      },
      {
        question: "What is the best month for snow?",
        answer: "January–February has deep snow. March has snow + blooming rhododendrons — magical combination."
      },
      {
        question: "Is Chandrashila the same as Tungnath?",
        answer: "No. Tungnath is the temple at 3,680m. Chandrashila is the summit peak at 4,000m, 1.5 km further."
      },
      {
        question: "Are mules available on the trail?",
        answer: "Yes, mule services available from Chopta to Tungnath (₹300–500 extra)."
      },
      {
        question: "Is altitude sickness a risk?",
        answer: "Minimal, given the gradual ascent. Acclimatization at Chopta on Day 1 helps significantly."
      },
      {
        question: "What connectivity is available?",
        answer: "BSNL has some connectivity in Chopta. Beyond Tungnath, no signal."
      },
      {
        question: "Can senior citizens do this?",
        answer: "Yes — trekkers up to 65 years regularly complete this. Moderate fitness required."
      }
    ],
  ...
  },
  {
    ...
    description: "Hidden in Govind National Park, Har Ki Dun — 'Valley of Gods' — is a mythologically rich horseshoe valley believed to be the Pandavas' route to heaven, flanked by Swargarohini (6,252m) and medieval Garhwali villages.",
    overview: "Har Ki Dun — literally 'Valley of Gods' in old Sanskrit — is one of the most mythologically rich trekking valleys in the Himalayas. Hidden deep in the Govind National Park of Uttarkashi district, this ancient valley is believed to be the route the Pandavas took to heaven (Swargarohini — the heavenly staircase — is the prominent peak here). Traditional Garhwali villages of Osla and Gangaad, with their centuries-old wooden temples and slate-roofed homes, line the trail. The Supin River accompanies you throughout, through thick forests of oak, pine, walnut, and rhododendron.",
    itinerary: [
      {
        day: 1,
        title: "Dehradun → Sankri",
        description: "Drive 200km via Mussoorie, Purola, Mori, Netwar along the dramatic Tons River gorge. Arrive Sankri (6,400 ft). Briefing and dinner.",
        highlights: [
          "Tons River gorge",
          "Mountain scenery",
      ...
      },
      {
        ...
        description: "Drive to Dharkot then 5km trek through dense mixed forest and meadows. Cross streams to Cheludgad camp (8,158 ft).",
        highlights: [
          "Dense forest trail",
          "Stream crossings",
          "Stargazing at camp"
      ...
      },
      {
        ...
        description: "12km trek through Gangaad village (traditional wooden architecture), open ridgelines at Kalkatiyadhar with first Swargarohini views.",
        highlights: [
      ...
      },
      {
        ...
        description: "Trek to the bowl-shaped Har Ki Dun Valley — vast, green, divine. Explore Maninda glacial lake, Jaundhar Glacier viewpoint. Swargarohini dominates.",
        highlights: [
      ...
      },
      {
        ...
        description: "Trek through Osla village — a living museum with 500-year-old Duryodhana temple. Riverside trails along Supin River.",
        highlights: [
      ...
      },
      {
        ...
        description: "Final 6km descent to Sankri. Drive back to Dehradun via Tons River valley.",
    ...
    faqs: [
      {
        ...
        answer: "Local legend says Duryodhana was once kind to this community. The wooden temple is 500+ years old."
      },
      {
        question: "Is Har Ki Dun good for first-time trekkers?",
        answer: "Yes — gradual altitude gain, good trails. Longer distance but manageable daily segments."
      },
      {
      ...
      },
      {
        ...
        answer: "May–June for rhododendrons and Himalayan wildflowers in full bloom."
      },
      {
        question: "Is the Jaundhar Glacier accessible?",
        answer: "Viewpoint is accessible; glacier base requires additional acclimatization day."
      },
      {
        question: "What wildlife might I see?",
        answer: "Himalayan griffon, monal pheasant, musk deer, Himalayan black bear (rare), snow leopard signs."
      },
      {
      ...
      },
      {
        ...
        answer: "Yes — 3km extension from Har Ki Dun to Ruinsara Lake. Extra day required."
      }
    ],
    ...
    quickFacts: {
      maxAltitudeZone: "Sub-Alpine Zone (11,600 ft max) — comfortable for families",
      snowConditions: "Snow Nov–Apr at valley floor; clear May–Oct; autumn colours Oct",
      trailType: "Riverbed trail, dense oak-deodar forest, traditional stone villages, open valley floor",
      waterAvailability: "Tamsa River alongside entire trail; abundant streams; excellent water quality",
    ...
    safetyProtocol: {
      guideInfo: {
        ...
        certification: "NIM Certified Basic Mountaineering Course, First Aid & Wilderness Rescue",
      ...
      amsProtocol: {
        stage1: {
          ...
          treatment: "Rest at same altitude, 3L water, 250mg Diamox, monitor for 4 hours"
        },
        stage2: {
          symptoms: ["Persistent headache", "Vomiting", "SpO2 88–90%"],
          treatment: "Descend 500–1000ft, oxygen supplementation, contact base team"
        },
        stage3: {
          symptoms: ["Confusion", "Ataxia", "SpO2 below 85%"],
          treatment: "Emergency descent by stretcher/porter, oxygen continuously, helicopter from Osla LZ"
        }
      },
      evacuationProcedure: "Trail descent to Sankri (4–6 hours), vehicle to Bangan PHC or Uttarkashi hospital. Helicopter from Osla clearing for critical cases.",
      checkInFrequency: "2x daily health checks — morning and evening at every camp",
  ...
  },
  {
    ...
    description: "India's most beloved winter trek in Govind Wildlife Sanctuary — the Kedarkantha summit at 3,810m delivers arguably the finest 360° Himalayan panorama accessible on any Indian trek, with snow-laden deodar forests and magical camping en route.",
    overview: "Kedarkantha is the undisputed king of Indian winter treks. Situated in the Govind Wildlife Sanctuary of Uttarkashi, the summit at 3,810m offers what many consider the finest 360-degree panoramic view available on any accessible Himalayan trek in India. From the top, you see Swargarohini (6,252m), Bandarpunch (6,316m), Kala Nag (6,387m), Ranglana, Kedarnath Peak, and dozens of unnamed snow giants. The trail weaves through magical snow-laden deodar and pine forests, open clearings, and three high-altitude campsites — each more spectacular than the last.",
    itinerary: [
      {
        day: 1,
        title: "Dehradun → Sankri",
        description: "Drive 200km via Mussoorie–Purola–Mori. Arrive Sankri (6,400 ft). Trek briefing, warm dinner.",
        ...
        emergencyExit: "Return to Dehradun via same road — nearest hospital Vikas Nagar 90km",
        photographyHighlights: [
          "Mussoorie skyline at dawn",
          "Tons River gorge near Mori",
          "First Himalayan peak views at Purola"
        ],
        weatherPattern: "Clear mornings; afternoon clouds possible above Mussoorie in monsoon",
        wildlife: [
          "Langur monkeys near Mussoorie",
          "Eagles and kites along valley"
        ],
        culturalNotes: "Pass through Govind Pashu Vihar National Park gateway at Netwar; region known for traditional Jaunsari culture",
        sunriseTime: "6:15 AM",
        sunsetTime: "7:00 PM"
      },
      {
        ...
        description: "4km trek through dense oak and pine forest. Reach Juda Ka Talab — alpine lake formed from Lord Shiva's tears. Frozen in winter. Magical stargazing camp.",
        highlights: [
          "Sacred alpine lake",
        ...
        duration: "4-5 hours",
        dayDifficulty: "Moderate",
        terrain: "Dense oak-pine forest, narrow ridge trail, frozen lake clearing",
        campsite: {
          name: "Juda Ka Talab",
          altitude: 9100,
          amenities: [
        ...
        weatherPattern: "Cold mornings (0–5°C Dec–Feb); clear afternoons; occasional snowfall Dec–Mar",
        wildlife: [
          "Red fox",
        ...
        culturalNotes: "Trail passes through Govind Pashu Vihar Wildlife Sanctuary — no campfire restrictions apply",
        acclimatizationNotes: "First night above 9,000ft — drink 3L water, avoid alcohol, rest early",
        sunriseTime: "6:30 AM",
        sunsetTime: "6:45 PM"
      },
      {
        ...
        description: "4km trek through increasingly open terrain. Snow patches grow heavier. Kedarkantha peak appears. Base camp at large meadow with 270° mountain view.",
        highlights: [
        ...
        mealDetail: {
          ...
          dinner: "Paneer butter masala, jeera rice, dal soup, chapati, hot chocolate",
          snacks: "Roasted peanuts, dates, energy bars; mandatory hot soup 4 PM"
        },
        waterSources: [
          "Stream at Bhoja Dhadi forest edge (last reliable water before summit)"
        ],
        emergencyExit: "Descend to Juda Ka Talab (2hrs) or Sankri (4hrs) via Day 2 trail",
        photographyHighlights: [
        ...
        weatherPattern: "Cold (−5 to −15°C Dec–Feb); strong ridge winds possible; clear skies common in winter for star gazing",
        wildlife: [
          "Himalayan tahr",
          "Snow leopard (rare)",
          "Griffon vultures overhead"
        ],
        acclimatizationNotes: "Summit briefing at 5 PM — guide checks SpO2 for all trekkers; anyone below 90% SpO2 stays at camp next day",
        sunriseTime: "6:45 AM",
        sunsetTime: "6:30 PM"
      },
      {
        ...
        description: "2 AM wake-up. Summit climb under stars — watch the Milky Way. Sunrise from Kedarkantha Summit (12,500 ft) — ocean of snow peaks in all directions. Descend to Sankri.",
        highlights: [
        ...
        duration: "7-9 hours",
        dayDifficulty: "Hard",
        terrain: "Steep snow slope, narrow snow ridge, summit rocks; long forest descent to Hargaon",
        campsite: {
          name: "Hargaon Camp",
          altitude: 8900,
        ...
        emergencyExit: "Abort summit → return to base camp (1.5hrs); mid-descent → Sankri via Hargaon alternate trail",
        photographyHighlights: [
        ...
        weatherPattern: "Summit attempt 4–7 AM to avoid afternoon clouds; wind chill −20°C possible at summit in winter; clear views before 10 AM",
        wildlife: [
          "Snow pigeons at summit",
          "Himalayan griffon vultures circling thermals"
        ],
        acclimatizationNotes: "Summit at 12,500ft — SpO2 checks at base before departure; turn back if below 88%",
    ...
    faqs: [
      {
        ...
        answer: "2–4 feet of snow on trail. Crampons/microspikes provided by The Global Trek."
      },
      {
        question: "Is a sleeping bag provided?",
        answer: "The Global Trek provides -10°C sleeping bags. Bring your own inner liner for extra warmth."
      },
      {
      ...
      },
      {
        ...
        answer: "Yes — guides assess weather every evening. Summit is called off if unsafe."
      },
      {
        question: "Is Kedarkantha suitable in summer?",
        answer: "Yes, but summer loses the snow magic. May–June has wildflowers."
      },
      {
        question: "What's the success rate?",
        answer: "The Global Trek's summit success rate is 94% across all seasons."
      },
      {
        question: "Is altitude sickness common?",
        answer: "Unlikely with proper acclimatization days built in. Guides monitor all trekkers."
      },
      {
        question: "Can I extend to Phulara Ridge?",
        answer: "Yes — Phulara Ridge shares the Sankri base and can be combined."
      }
    ],
    ...
    quickFacts: {
      ...
      trailType: "Dense oak/pine forest, open meadows, snow ridge, rocky summit",
      waterAvailability: "Streams at Khujai & Dhoka; carry 2L above Bhoja Dhadi",
    ...
    safetyProtocol: {
      guideInfo: {
        ...
        certification: "NIM (Nehru Institute of Mountaineering) Certified, WFR Level 3, Wilderness First Aid",
      ...
      amsProtocol: {
        stage1: {
          ...
          treatment: "Rest at same altitude, 3L water, 250mg Diamox, no further ascent until SpO2 > 92%"
        },
        stage2: {
          symptoms: [
          ...
          treatment: "Immediate descent 1,000ft minimum, oxygen supplementation, emergency contact to Sankri base"
        },
        stage3: {
          symptoms: [
          ...
          treatment: "Emergency helicopter evacuation, continuous oxygen, IV Dexamethasone, helicopter to Dehradun/Rishikesh hospital"
        }
      },
      evacuationProcedure: "Walk-out to Sankri (2–4 hours depending on camp), vehicle to Mori CHC (42km), helicopter from Sankri meadow LZ for critical cases. Satellite phone contact with base team maintained throughout.",
      checkInFrequency: "3x daily SpO2 checks — morning, midday, evening at every campsite",
    ...
    detailedReviews: [
      ...
      },
      {
        ...
        comment: "We chose Kedarkantha for our honeymoon and it exceeded every expectation. The base camp at night with the Milky Way blazing overhead was more romantic than any hotel could be. Guide team was incredibly professional — daily health checks, full safety briefing at each camp. Summit day was tough but our guide kept pace perfectly. Hot chocolate waiting at camp after the summit push — these small touches made all the difference. Value for money is exceptional for the quality of service.",
        date: "2023-12-18",
        month: 12,
        groupType: "couple",
        verified: true,
    ...
    batchSlots: [
      {
        ...
        meetingPoint: "Dehradun Railway Station (DOON EXPRESS platform) at 7:00 AM",
  ...
  },
  {
    ...
    description: "The legendary Curzon Trail in Chamoli district offers the finest panoramic view of Nanda Devi (7,816m — India's highest peak in Indian territory), with fairy-tale oak and rhododendron forests, vast bugyals, and a dramatic high mountain pass at 4,264m.",
    overview: "Named after Lord Curzon who explored it in the British era, the Kuari Pass trek is a legendary Himalayan crossing in the Chamoli district of Garhwal. It offers arguably the finest panoramic view of the Nanda Devi massif (7,816m — India's highest peak fully in Indian territory) in all of Himalayan trekking. Other peaks visible: Trishul (7,120m), Dronagiri (7,066m), Kamet (7,756m), Chaukhamba, and Hathi-Ghodi. The trail passes through fairy-tale forests of oak, rhododendron, and pine; open bugyal (high-altitude meadow) country; and ancient shepherd paths.",
    itinerary: [
      {
        day: 1,
        title: "Haridwar → Joshimath",
        description: "Drive 270km through Devprayag, Rudraprayag, Chamoli, Pipalkoti to Joshimath — gateway to Nanda Devi region. Explore Narasimha Temple. Briefing.",
        highlights: ["Devprayag sangam", "Joshimath town", "Narasimha Temple"]
      },
      {
        day: 2,
        title: "Joshimath → Gulling Camp",
        description: "Drive to Dhak village. 7km trek through oak-rhododendron forest. Village of Tugasi. Meadow views open at Gulling camp with early Trishul views.",
        highlights: ["Tugasi village", "Trishul views", "Forest trail"]
      },
      {
        day: 3,
        title: "Gulling → Khullara",
        description: "Trail opens into Khullara bugyal — one of the Garhwal Himalayas' finest meadow campsites. Full Himalayan wall appears: Nanda Devi, Trishul, Dronagiri side by side.",
        highlights: [
      ...
      },
      {
        ...
        description: "Summit day. Ridge walk above tree line. Snow patches. Kuari Pass (13,990 ft) — sweeping arc of Himalayan peaks. The finest mountain panorama in India. Return to Khullara.",
        highlights: [
          "Kuari Pass (4,264m)",
          "360° Himalayan arc",
          "Nanda Devi close-up"
    ...
    faqs: [
      {
        ...
        answer: "Moderate — 2–3 months of cardio fitness preparation recommended. Beginners with good fitness can manage."
      },
      {
        question: "Is Kuari Pass good for photography?",
        answer: "Exceptionally so — Khullara camp and pass summit are among the most photographed in Indian trekking."
      },
      {
        question: "What permits are needed?",
        answer: "Forest permit + Nanda Devi Biosphere Reserve entry. The Global Trek handles all."
      },
      {
        question: "What's the Lord Curzon connection?",
        answer: "Viceroy of India Lord Curzon trekked this route in 1905. 'Curzon Trail' is its historic name."
      },
      {
        question: "Any risk of altitude sickness?",
        answer: "Moderate risk at 13,990 ft. The Global Trek builds in proper acclimatization days."
      },
      {
        question: "Is it a loop or return trek?",
        answer: "Out-and-back from Khullara, or loop via Auli. Ask for the Auli extension."
      },
      {
        question: "Best month for snow + clear skies?",
        answer: "October and November — post-monsoon clarity with early snowfall on peaks."
      },
      {
        question: "Can I combine with Kedarnath or Badrinath?",
        answer: "Yes — Joshimath is the base for both. The Global Trek offers combination packages."
      }
    ],
  ...
  },
  {
    ...
    description: "Hampta Pass is India's most dramatic trekking crossover — from the lush, forested Kullu Valley to the stark, moon-like Lahaul desert in a single day at the pass, with genuine river crossings and optional Chandratal Lake extension.",
    overview: "Hampta Pass is one of India's most dramatic trekking experiences — a trans-Himalayan crossover that transitions from the lush, forested Kullu Valley to the stark, moon-like desert of Lahaul in a single dramatic day at the pass. No other trek in the country offers such a violent, beautiful contrast in landscape. On one side: green forests, waterfalls, wildflower meadows. Cross the 14,100 ft pass and: barren brown mountains, glacial rivers, zero vegetation, Tibetan plateau feel. The trek also involves genuine river crossings using fixed ropes — cold, knee-deep glacial streams that add a thrilling dimension.",
    itinerary: [
      {
        day: 1,
        title: "Manali → Chika Camp",
        description: "Drive 20km to Jobra then 3km trek. Rani Nallah river crossing. Reach Chika camp (9,800 ft) in grassy clearing with birch-rhododendron backdrop.",
        highlights: [
          "Alni village",
      ...
      },
      {
        ...
        description: "10km trek along Hampta River valley floor. Dramatic mountain walls on both sides. Multiple stream crossings. Rocky alpine camp at glacier base.",
        highlights: [
          "River valley trail",
          "Mountain walls",
      ...
      },
      {
        ...
        description: "Summit day — steep early climb, rope-assisted river crossings. Cross Hampta Pass (14,100 ft). Instant landscape flip from green Kullu to barren brown Lahaul. Descend to Shea Goru in lunar landscape.",
        highlights: [
          "Hampta Pass (4,300m)",
      ...
      },
      {
        ...
        description: "5km trek across barren Lahaul. Arrive Chatru on Chandra River. Optional: drive to Chandratal Lake (turquoise crescent lake, one of Himachal's most stunning).",
        highlights: [
    ...
    faqs: [
      {
        ...
        answer: "Moderate — river crossings and altitude make it best for trekkers with at least one prior multi-day trek."
      },
      {
        question: "When do the river crossings happen?",
        answer: "Multiple stream crossings on Days 1–3. The biggest crossings are before Balu Ka Ghera and at the pass itself."
      },
      {
        question: "What footwear for river crossings?",
        answer: "Carry extra sandals/crocs for crossings. Keep trekking shoes dry for the trail."
      },
      {
        question: "Is Chandratal Lake worth it?",
        answer: "Absolutely yes — considered one of India's most beautiful lakes. Highly recommended."
      },
      {
        question: "Can I continue to Spiti Valley?",
        answer: "Yes — The Global Trek offers Hampta Pass + Chandratal + Spiti road trip combination."
      },
      {
        question: "What is the altitude risk?",
        answer: "14,100 ft is significant. The Global Trek includes mandatory acclimatization at Manali."
      },
      {
        question: "Why only done in summer?",
        answer: "Monsoon is fine (Himachal gets less rain). Pre/post-monsoon has best clear skies."
      },
      {
        question: "Is there mobile connectivity?",
        answer: "Until Chika (Day 1). Beyond that, no signal until Chatru (BSNL sometimes)."
      }
    ],
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        description: "9km ascent through dense forest. Reach Min Thach open meadow (10,500 ft).",
        highlights: [
          "Dense deodar forest",
          "Min Thach meadow",
      ...
      },
      {
        ...
        description: "8km trek into high-altitude terrain. Snow begins in earnest. Parvati Valley unfolds below. Camp at Nagaru with first-row pass views.",
        highlights: [
          "First heavy snow",
      ...
      },
      {
        ...
        description: "Summit day — early morning climb to Sar Pass (4,220m). Frozen lake. Panoramic views. Then THE ICONIC SNOW SLIDE — trekkers slide down the 45–70° snowfield for 200m. Unforgettable.",
        highlights: [
      ...
      },
      {
        ...
        description: "Final descent through forest to Barshaini. Drive to Kasol.",
    ...
    faqs: [
      {
        ...
        answer: "A natural snow slope on the descent from Sar Pass where trekkers slide down on their backs/bottoms for 100–200m. One of the most fun moments in Indian trekking."
      },
      {
        question: "Is it safe?",
        answer: "Yes — the slide zone is scouted before descent. Guides create a controlled path and stand at the bottom."
      },
      {
        question: "When is there guaranteed snow?",
        answer: "May–June has the heaviest snow. By September, snow is minimal."
      },
      {
      ...
      },
      {
        ...
        answer: "Yes — Kasol has charming cafés, Manikaran Gurudwara (hot spring), and Parvati Valley exploration."
      },
      {
        question: "What is the altitude risk?",
        answer: "13,800 ft is moderate-high. The gradual ascent and pacing minimize AMS risk."
      },
      {
        question: "YHAI vs The Global Trek?",
        answer: "YHAI runs mass batches of 50–80 trekkers. The Global Trek limits to 20 for a more personal, quality experience."
      },
      {
        question: "Any extension options?",
        answer: "Kheerganga hot spring trek (12 km, 2 days) from Kasol is a popular warm-up/cool-down extension."
      }
    ],
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        description: "7km through dense birch forest into alpine meadows. Kedarkantha peak visible in full form. Camp at Bhoj Gadi (11,170 ft) — the gateway to Phulara Ridge.",
        highlights: ["Birch forest", "Kedarkantha views", "Alpine meadow camp"]
      },
      {
        day: 4,
        title: "Phulara Ridge Walk → Pushtara Meadows",
        description: "The defining day — 4–5 continuous hours on the Phulara Ridge with Himalayan peaks 180° in both directions. Swargarohini, Kala Nag, Bandarpunch, Kedarkantha all simultaneously visible. Descend to pristine Pushtara Meadows (9,860 ft).",
        highlights: [
      ...
      },
      {
        ...
        description: "8km descent via Taluka village back to Sankri. Drive to Dehradun.",
    ...
    faqs: [
      {
        ...
        answer: "'Phulara' means 'flowering' in local dialect. The ridge blooms with alpine flowers in spring."
      },
      {
        question: "Is the ridge walk safe?",
        answer: "The ridge is broad (2–5m wide) for safe walking. Not a technical knife-edge."
      },
      {
        question: "How does this compare to Kedarkantha?",
        answer: "No summit push but the ridge walk experience is longer and more sustained. Many experienced trekkers prefer Phulara for its uniqueness."
      },
      {
        question: "Is it crowded?",
        answer: "Much less than Kedarkantha. The less-trodden path is a major attraction."
      },
      {
        question: "Can I combine with Kedarkantha?",
        answer: "Yes — 8-day combination possible using Sankri as base. The Global Trek offers this combined package."
      },
      {
        question: "What is Pushtara Meadow?",
        answer: "A high-altitude pastoral meadow used by Gujjar shepherds in summer. Completely undeveloped and pristine."
      },
      {
        question: "Is there snow on Phulara Ridge?",
        answer: "In winter (Dec–Mar) yes. In spring (Apr–May), patchy snow + wildflowers. Summer is green."
      },
      {
        question: "Is Phulara Ridge a loop?",
        answer: "No — it's a point-to-point trek from Sankri to Pushtara then Taluka. Transfer arranged."
      }
    ],
  ...
  },
  {
    ...
    description: "Kedarnath — the holiest of the 12 Jyotirlingas and the most sacred Shiva shrine in the Himalayas — a 19km trek from Gaurikund to the ancient stone temple at 3,583m built by Adi Shankaracharya, with the Kedarnath Glacier as backdrop.",
    overview: "Kedarnath is the holiest of the 12 Jyotirlingas and the most sacred Shiva shrine in the Himalayas. Nestled at 3,583m at the base of the Kedarnath Peak and Kedarnath Glacier, the stone temple (believed to be built by Adi Shankaracharya in the 8th century CE) has survived Himalayan winters, glacier floods, and the catastrophic 2013 cloudburst disaster. The 19 km trek from Gaurikund passes through magnificent forested terrain, the bustling pilgrim town of Rambara, Linchauli meadows, and arrives at the spiritual heart of Uttarakhand.",
    itinerary: [
      {
        day: 1,
        title: "Rishikesh → Gaurikund",
        description: "Drive 229km via Devprayag, Rudraprayag to Sonprayag. Biometric Yatra registration. Drive to Gaurikund (6,578 ft). Sacred hot springs. Briefing.",
        highlights: [
          "Devprayag sangam",
          "Yatra registration",
      ...
      },
      {
        ...
        description: "5 AM departure. 19km trek via Jungle Chatti, Bheembali, Linchauli to the sacred temple complex. Darshan at Kedarnath. Evening Aarti — the most moving mountain spiritual experience in India.",
        highlights: [
          "19km sacred trek",
      ...
      },
      {
        ...
        description: "Early morning Abhishek puja. Explore Gandhi Sarovar lake (2km above temple). Optional: Vasukital glacial lake. Afternoon return trek 19km to Gaurikund.",
        highlights: [
          "Abhishek puja",
          "Gandhi Sarovar lake",
          "Vasukital option"
      ...
      },
      {
        ...
        description: "Morning drive back. Drop at Rishikesh/Haridwar railway station.",
    ...
    faqs: [
      {
        ...
        answer: "Yes — Uttarakhand government requires biometric registration at Sonprayag. The Global Trek assists with this."
      },
      {
        question: "When does Kedarnath temple open/close?",
        answer: "Opens on Akshaya Tritiya (Apr/May). Closes on Bhai Dooj (Nov). Exact dates vary by Hindu calendar."
      },
      {
        question: "Is helicopter the only alternative to trekking?",
        answer: "Yes. Helipad at Phata/Sersi. The Global Trek offers helicopter packages. Pre-booking essential."
      },
      {
        question: "How was Kedarnath affected in 2013?",
        answer: "The 2013 disaster (June 16–17) killed thousands. The temple structure survived, protected by a large boulder."
      },
      {
        question: "What is the Panch Kedar?",
        answer: "Five sacred Shiva temples: Kedarnath, Tungnath, Rudranath, Madmaheshwar, Kalpeshwar. The Global Trek offers the complete Panch Kedar yatra."
      },
      {
        question: "What to carry for darshan?",
        answer: "No leather items inside. Photography allowed outside only. Prasad available at temple."
      },
      {
        question: "Is Kedarnath suitable for elderly?",
        answer: "With helicopter, yes. Pony/palki (palanquin) services available for the trek."
      },
      {
        question: "What is Gandhi Sarovar?",
        answer: "A small lake 2km above the temple, named after Mahatma Gandhi's ashes immersion. Peaceful and less visited."
      }
    ],
  ...
  },
  {
    ...
    description: "Do Dham covers the two most sacred shrines of the Garhwal Himalayas — Kedarnath (Lord Shiva's jyotirlinga) and Badrinath (Lord Vishnu's dhama) — the spiritual heart of Uttarakhand, in a condensed, deeply fulfilling format.",
    overview: "Do Dham Yatra covers the two most sacred shrines of the Garhwal Himalayas — Kedarnath (the Shiva jyotirlinga) and Badrinath (the Vishnu dhama). Together, they form the spiritual heart of Uttarakhand's Char Dham. For those unable to undertake the full Char Dham Yatra, Do Dham provides the most essential pilgrimage experience in a condensed, deeply fulfilling format that includes the complete Kedarnath trek, Badrinath darshan, Mana Village, Tapt Kund, and Brahma Kapal.",
    itinerary: [
      {
        day: 1,
        title: "Haridwar → Guptkashi",
        description: "Drive 210km. Check in at Guptkashi — base for Kedarnath. Visit Ardhnarishwar Temple.",
        highlights: ["Guptkashi town", "Ardhnarishwar Temple"]
      },
      {
        day: 2,
        title: "Guptkashi → Kedarnath Trek",
        description: "Drive to Gaurikund. Trek 19km to Kedarnath Temple. Evening Aarti.",
      ...
      },
      {
        ...
        description: "Drive 240km via Rudraprayag–Chamoli–Joshimath to Badrinath.",
        highlights: [
      ...
      },
      {
        ...
        description: "Brahma Muhurta Abhishek, Tapt Kund holy dip, Badri-Vishal darshan, Brahma Kapal puja, Mana Village (last Indian village before Tibet), Vyas Gufa, Saraswati River.",
        highlights: [
          "Tapt Kund holy dip",
      ...
      },
      {
        ...
        description: "Buffer day for weather or delays. Departure from Haridwar.",
    ...
    faqs: [
      {
        ...
        answer: "Kedarnath (Shiva jyotirlinga) + Badrinath (Vishnu dhama) — the two most sacred shrines in the Garhwal Himalayas."
      },
      {
        question: "Can elderly do Do Dham?",
        answer: "Yes — Badrinath is road-accessible. Helicopter/palki available for Kedarnath."
      },
      {
        question: "What is Tapt Kund?",
        answer: "A natural hot spring (45°C) at Badrinath entrance. All pilgrims traditionally dip before temple."
      },
      {
        question: "What is Brahma Kapal?",
        answer: "A flat rock platform at Badrinath on Alaknanda River for pind-daan (ancestor soul liberation) rituals."
      },
      {
        question: "What is Mana Village?",
        answer: "India's last village before the Tibet border — has Vyas Gufa, Ganesh Gufa, Bhim Pul (single rock bridge over Saraswati)."
      },
      {
        question: "How is Do Dham different from Char Dham?",
        answer: "Do Dham (Kedarnath + Badrinath) is the 2-shrine condensed version. Char Dham adds Yamunotri and Gangotri."
      },
      {
      ...
      },
      {
        ...
        answer: "Yes — nearby Joshimath. July–August it's in full bloom (UNESCO World Heritage)."
      }
    ],
  ...
  },
  {
    ...
    description: "India's holiest pilgrimage — four divine abodes established by Adi Shankaracharya: Yamunotri (source of Yamuna), Gangotri (source of Ganga), Kedarnath (Shiva), and Badrinath (Vishnu), following the west-to-east Himalayan arc.",
    overview: "Char Dham Yatra is one of India's most sacred pilgrimages — four divine abodes in the Garhwal Himalayas that every devout Hindu aspires to visit in their lifetime. According to Adi Shankaracharya who established these four dhams in the 8th century, completing the Char Dham Yatra washes away all sins and breaks the cycle of rebirth. The four dhams follow a west-to-east sequence: Yamunotri (3,291m), Gangotri (3,048m), Kedarnath (3,583m), and Badrinath (3,133m).",
    itinerary: [
      {
        day: 1,
        title: "Haridwar → Barkot",
        description: "Drive 170km via Rishikesh, Chamba, Dharasu to Barkot — base for Yamunotri.",
        highlights: ["Rishikesh transit", "Yamuna valley", "Barkot arrival"]
      },
      {
        day: 2,
        title: "Barkot → Yamunotri → Barkot",
        description: "Drive to Janki Chatti. Trek 6km to Yamunotri Temple (3,291m). Sacred Surya Kund boiling spring, Divya Shila, Yamuna darshan. Return to Barkot.",
        highlights: [
          "Yamunotri Temple",
      ...
      },
      {
        ...
        description: "Drive 100km to Uttarkashi on Bhagirathi River. Visit ancient Vishwanath Temple.",
        highlights: ["Uttarkashi town", "Vishwanath Temple"]
      },
      {
        day: 4,
        title: "Uttarkashi → Gangotri",
        description: "Drive 100km to Gangotri (3,048m). Sacred Bhagirathi River. Gangotri Temple darshan. Optional: 18km further to Gaumukh glacier.",
        highlights: [
          "Gangotri Temple",
      ...
      },
      {
        ...
        description: "Drive 240km via Chamba, Rishikesh, Rudraprayag to Guptkashi.",
        highlights: ["Devprayag sangam", "Rudraprayag", "Guptkashi"]
      },
      {
        day: 6,
        title: "Guptkashi → Kedarnath Trek",
        description: "Drive to Gaurikund. Trek 19km to Kedarnath (3,583m). Evening Aarti.",
        highlights: ["Kedarnath trek", "Jyotirlinga darshan", "Evening Aarti"]
      },
      {
        day: 7,
        title: "Kedarnath → Guptkashi",
        description: "Morning darshan and Abhishek puja. Descend 19km. Overnight Guptkashi.",
        highlights: ["Morning puja", "Trek descent"]
      },
      {
        day: 8,
      ...
      },
      {
        ...
        description: "Drive 50km to Badrinath. Tapt Kund dip. Badri-Vishal darshan. Brahma Kapal. Mana Village. Vyas Gufa, Ganesh Gufa, Bhim Pul.",
        highlights: [
          "Badrinath darshan",
          "Tapt Kund",
    ...
    faqs: [
      {
        ...
        answer: "Traditionally, yatris start from Yamunotri in the west and end at Badrinath in the east — representing the journey from birth to liberation."
      },
      {
        question: "Can elderly complete Char Dham?",
        answer: "All dhams except Kedarnath are road-accessible. Helicopter/palki for Kedarnath makes it accessible for all ages."
      },
      {
        question: "What is Gaumukh?",
        answer: "The glacier mouth — actual source of the Ganga — 18km from Gangotri. A powerful trekking extension."
      },
      {
        question: "What is Tapt Kund at Badrinath?",
        answer: "A natural hot spring (45°C) at the temple entrance. All pilgrims traditionally dip before entering."
      },
      {
        question: "Is Mana Village worth visiting?",
        answer: "Absolutely — the last village before Tibet has Vyas Gufa (where Mahabharata was composed), Ganesh Gufa, Bhim Pul, and authentic Bhotiya culture."
      },
      {
        question: "How crowded is Char Dham season?",
        answer: "Peak (June + September) is extremely crowded. The Global Trek recommends May or October."
      },
      {
        question: "What is Brahma Kapal?",
        answer: "A flat rock platform at Badrinath on the Alaknanda River where Hindus perform pind-daan (ancestor soul liberation rituals)."
      },
      {
        question: "Is Valley of Flowers worth adding?",
        answer: "Yes — July–August it's a UNESCO World Heritage Site carpeted in 300+ wildflower species. Highly recommended as an add-on."
      }
    ],
