...
const kedarnathItinerary: ItineraryDay[] = [
  {
    ...
    description:
      "Depart from Haridwar Railway Station at 6:00 AM in our private tempo traveller. The 230km journey winds through the Garhwal Himalayan foothills — past Devprayag (Alaknanda–Bhagirathi confluence), Srinagar (Garhwal), and Rudraprayag (Mandakini–Alaknanda confluence) before reaching Sonprayag (6,100ft) by evening. Check-in at pre-booked guesthouse, dinner, safety briefing, and RFID wristband distribution.",
    highlights: [
    ...
    mealDetail: {
      ...
      lunch:
        "En route dhaba near Rudraprayag — dal tadka, chapati, rice, sabzi",
    ...
    emergencyExit:
      "Any point on NH58/State Highway — full road connectivity throughout. Nearest government hospital: CHC Ukhimath (25km from Sonprayag) or Rudraprayag District Hospital (75km).",
    ...
    weatherPattern:
      "May–June: 15–22°C days, 8–12°C nights, clear. Sept–Oct: 12–18°C days, 5–8°C nights, occasional fog morning.",
    wildlife: [
      "Langur monkeys (road-side)",
      "Himalayan Griffon Vultures (thermal soaring)",
    ],
    culturalNotes:
      "Devprayag is where the Ganga is formally named — Bhagirathi (from Gangotri) meets Alaknanda here. Rudraprayag is named after Lord Shiva (Rudra). The Panch Prayag (five sacred confluences) all lie on this route.",
    acclimatizationNotes:
      "No significant altitude yet. Drink 3L water today. Avoid alcohol. Sleep at 6,100ft is gentle acclimatization for the days ahead.",
  },
  {
    day: 2,
    title: "Sonprayag → Gaurikund → Jungle Chatti → Bheembali",
    description:
      "Wake at 5:30 AM. Shared jeep (6km, 30 min) from Sonprayag to Gaurikund (6,503ft) — private vehicles not permitted beyond Sonprayag. Hot spring dip at Gaurikund (optional, spiritually significant). Trek begins at Gaurikund base gate after RFID scan. Trail climbs through dense rhododendron and oak forest, passing Jungle Chatti tea stalls (7,890ft) before the long ascent to Bheembali government medical post (9,334ft). 9km, 6 hours.",
    highlights: [
    ...
    terrain:
      "Paved stone steps and gravel trail through rhododendron/oak forest, then open alpine scrub",
    campsite: {
    ...
    mealDetail: {
      ...
      lunch:
        "Jungle Chatti tea stalls — Maggi noodles, chai, biscuits (carried packed lunch)",
    ...
    emergencyExit:
      "Government medical checkpost at Bheembali (9,334ft) with basic emergency care and oxygen. Helicopter pad access point: Phata Helipad (30 min descent to road + 10 min drive). Jeep connectivity at Gaurikund for road evacuation.",
    photographyHighlights: [
    ...
    weatherPattern:
      "May: 10–18°C, afternoon mist possible. June: 12–20°C at start, 6–10°C at Bheembali. Sept: clearest skies, 8–14°C. Oct: 4–10°C at Bheembali, morning frost possible.",
    wildlife: [
    ...
    culturalNotes:
      "Gaurikund is named for Goddess Gauri (Parvati). The hot spring here is believed to be where she prayed for Lord Shiva. Pilgrims traditionally bathe here before ascending to Kedarnath. The trail is the ancient Panch Kedar pilgrimage route used for centuries.",
    acclimatizationNotes:
      "Altitude gain is significant (+2,831ft in one day). Walk at 'Paidal Chalte Raho' pace — slow and steady. Headache at Bheembali is common and normal. Take Diamox 125mg if experiencing headache (guide carries supply). Do NOT push pace.",
  },
  {
    day: 3,
    title: "Bheembali → Lincholi → Kedarnath Base → Temple Darshan",
    description:
      "Early start at 6:00 AM. The trail continues above treeline through open alpine terrain. Pass Lincholi (9,908ft) — a significant halt point with medical facility. The last 3km from Kedarnath base camp (10,860ft) to the temple plateau (11,755ft) is the most spiritually charged section — the valley opens dramatically, the Kedarnath Peak (22,769ft) comes into full view, and the grey stone temple emerges against the glacier. Arrive for evening Sandhya Aarti (5:00 PM). 7km, 5 hours.",
    highlights: [
    ...
    dayDifficulty: "Moderate",
    terrain:
      "Open alpine trail, rocky switchbacks, moraine edges, final temple plaza stone pavement",
    campsite: {
    ...
    emergencyExit:
      "Kedarnath has dedicated emergency helipad (used in 2013 rescue). NDRF post at base camp. Helicopter evacuation available from temple helipad in severe cases — 8 min to Phata/Guptkashi. 24hr oxygen facility at GMVN medical center.",
    photographyHighlights: [
    ...
    weatherPattern:
      "At 11,755ft: May–June: 2–8°C days, -2–2°C nights. September: 4–10°C days, 0–4°C nights. October: 0–6°C days, -5–0°C nights. Wind can be strong (30–50km/h) at any time. Snow possible October onwards.",
    wildlife: [
    ...
    culturalNotes:
      "Kedarnath is one of the 12 Jyotirlingas and the most northernmost. The temple was built (or restored) by Adi Shankaracharya in the 8th century CE. The Samadhi of Adi Shankaracharya is directly behind the temple. The legend: after the Kurukshetra war, the Pandavas sought Lord Shiva's forgiveness; Shiva fled in bull form and submerged here, leaving only his hump above ground — worshipped as the Shivalinga. The same divine bull's face is worshipped at Rudranath, arms at Tungnath, belly at Madmaheshwar, and locks at Kalpeshwar — the Panch Kedar pilgrimage.",
    acclimatizationNotes:
      "11,755ft is the high point. If any pilgrim shows HACE/HAPE symptoms (confusion, severe headache, gurgling sound in chest), immediate descent and oxygen administration. Guide has pulse oximeter — SpO2 below 85% triggers evacuation protocol. Spend maximum time at temple, not rushing. Slow pace on final ascent.",
  ...
  },
  {
    ...
    description:
      "Wake at 3:00 AM for Pratah Puja (4:00–7:00 AM) — the most sacred slot requiring pre-registration. Attend Rudrabhishek or Sampoorna Puja as booked. Full temple circuit: garbhagriha, outer pradakshina, Adi Shankaracharya samadhi at rear, Hamsa Kund nearby. Begin descent to Gaurikund by 10:00 AM — descent is physically gentler but requires careful footing on stone steps. Reach Gaurikund by 5:00 PM. Hot spring bath, prasad dinner. 16km descent, 7 hours.",
    highlights: [
    ...
    dayDifficulty: "Moderate",
    terrain:
      "Stone-paved steps and gravel trail — steep in sections, requires trekking poles for descent",
    campsite: {
    ...
    mealDetail: {
      ...
      dinner:
        "Gaurikund dhaba — special celebratory meal, mithai (sweets), chai",
    ...
    emergencyExit:
      "Full road connectivity at Gaurikund. Government medical posts at Bheembali and Lincholi for descent injuries. Pony/doli available if knee injury occurs on descent (common — inform guide immediately). Phata helicopter pad reachable within 2 hours of upper trail.",
    photographyHighlights: [
    ...
    weatherPattern:
      "Morning descent often has the clearest views. By 2–3 PM, clouds typically build from valleys. Descent in light rain is common — rain covers provided.",
    wildlife: [
    ...
    culturalNotes:
      "The Adi Shankaracharya samadhi at the rear of the temple is where the great philosopher-saint attained mahasamadhi (final liberation) at age 32. Performing pradakshina (circumambulation) of the main temple 3 times is traditional. Hamsa Kund is where Brahma is said to have performed tapas.",
    acclimatizationNotes:
      "Descending rapidly from 11,755ft — AMS symptoms typically resolve on descent. Ensure trekking poles are used to protect knees on long stone-step descent. Hydrate continuously. Watch for fatigue-induced slip risk.",
  },
  {
    day: 5,
    title: "Gaurikund → Sonprayag → Rishikesh (Drive)",
    description:
      "Breakfast at Gaurikund, shared jeep back to Sonprayag, then our vehicle departs at 9:00 AM for the return 230km drive to Rishikesh/Haridwar. Stop at Rudraprayag for lunch and final puja at the Rudranath temple (one of the Panch Kedar group). Arrive Rishikesh/Haridwar by 6:00–7:00 PM. Optional Ganga Aarti at Har Ki Pauri if arriving before sunset. Trip concludes here.",
    highlights: [
    ...
    emergencyExit:
      "Full highway connectivity throughout. No altitude concerns.",
    photographyHighlights: [
    ...
    weatherPattern:
      "Variable valley weather. Usually pleasant by Rishikesh altitude.",
    wildlife: [],
    culturalNotes:
      "Haridwar (Gateway to God) is one of the seven holiest Hindu cities. Har Ki Pauri ghat is where the Ganga descends from the mountains to the plains — the evening aarti here has occurred daily for centuries. Completing a Kedarnath yatra and attending the Haridwar aarti on return is traditional.",
    acclimatizationNotes:
      "Descending to valley altitude — no AMS concerns. Fatigue is normal after 4 days of trekking. Rest recommended on Day 6 before resuming normal activities.",
  },
];

const kedarnathSafety: SafetyProtocol = {
  guideInfo: {
    name: "Rameshwar Prasad Tiwari",
    certification:
      "NIM Certified Trek Leader, WFR Level 2, Government of Uttarakhand Licensed Mountain Guide",
  ...
  amsProtocol: {
    stage1: {
      ...
      treatment:
        "Stop ascent. Rest 30 min. Hydrate (500ml water). Paracetamol for headache. Monitor SpO2. If no improvement in 1 hour, administer Diamox 125mg. Do NOT ascend further until symptom-free for 4 hours.",
    },
    stage2: {
      symptoms: [
      ...
      treatment:
        "Immediate descent minimum 500m. Administer oxygen via mask (2–4L/min). Give Diamox 250mg. Contact base via satellite phone. Prepare for helicopter evacuation if descent route is blocked.",
    },
    stage3: {
      symptoms: [
      ...
      treatment:
        "EMERGENCY. Administer O2 at 6L/min. Dexamethasone 8mg IV/IM (HACE) or Nifedipine 30mg (HAPE). Activate helicopter evacuation immediately. Do NOT leave patient alone. Descent by doli/stretcher if helicopter delayed.",
    },
  },
  evacuationProcedure:
    "1. Guide activates Garmin inReach SOS. 2. Call Kedarnath Emergency Control Room (+91-1364-234340). 3. Call Phata Helipad (+91-9411386802). 4. Prepare patient for helicopter stretcher board. 5. Nearest hospital: Rudraprayag District Hospital (75km, ICU available). 6. Notify next of kin via satellite message.",
  checkInFrequency:
    "3x daily pulse oximetry checks — morning, lunch, evening camp",
...
const kedarnathBatches: BatchSlot[] = [
  {
    id: "kn-b1",
    ...
    notes:
      "Opening season — high spiritual energy, some snow possible on upper trail",
  },
  {
    id: "kn-b2",
  ...
  },
  {
    ...
    guide: "Dinesh Uniyal",
    notes:
      "Last batch before temple closing — Diwali season, special atmosphere",
  },
];

const kedarnathReviews: Review[] = [
  {
    id: "kn-r1",
...
const charDhamSafety: SafetyProtocol = {
  guideInfo: {
    name: "Bhupendra Singh Negi",
    certification:
      "NIM & HMI Certified Senior Trek Leader, UIAA Mountain Guide Level 2, Uttarakhand Tourism Licensed",
  ...
  satellitePhone: {
    ...
    coverage:
      "Global Iridium satellite network — 100% coverage across all 4 Dhams",
  },
  helicopterLandingZone: {
    location:
      "Phata Helipad (Kedarnath sector) / Harsil airstrip (Gangotri sector)",
  ...
  nearestHospital: {
    ...
    distance:
      "280 km from Badrinath (AIIMS); local CHCs within 25 km of each Dham",
  ...
  amsProtocol: {
    stage1: {
      ...
      treatment:
        "Halt ascent. Hydrate. Paracetamol. Monitor SpO2. Diamox 125mg if no improvement in 1 hour.",
    },
    stage2: {
      symptoms: [
        "Severe headache",
      ...
      treatment:
        "Immediate descent 500m. O2 via mask 2–4L/min. Diamox 250mg. Satellite SOS if required.",
    },
    stage3: {
      symptoms: ["HACE confusion", "HAPE gurgling", "Cyanosis", "SpO2 < 75%"],
      treatment:
        "Emergency O2 6L/min. Dexamethasone/Nifedipine. Immediate helicopter evacuation.",
    },
  },
  evacuationProcedure:
    "Activate Garmin inReach SOS. Contact nearest district emergency. Helicopter from Phata (Kedarnath) or Harsil (Gangotri). AIIMS Rishikesh as primary receiving hospital.",
  checkInFrequency:
    "3x daily SpO2 checks; morning health briefing; evening debrief",
...
const charDhamBatches: BatchSlot[] = [
  {
    id: "cd-b1",
  ...
  },
  {
    ...
    guide: "Bhupendra Negi",
    notes:
      "Final batch — Navratri + Diwali season closing, last chance for 2026",
  },
];

const charDhamReviews: Review[] = [
  {
    id: "cd-r1",
...
const doDhamSafety: SafetyProtocol = {
  guideInfo: {
    name: "Prakash Ramola",
    certification:
      "NIM Certified, Uttarakhand Tourism Licensed Mountain Guide, Wilderness First Responder",
  ...
  helicopterLandingZone: {
    ...
    coordinates:
      "30.7597°N, 78.9756°E (Phata); 30.7433°N, 79.4938°E (Badrinath)",
  ...
  amsProtocol: {
    stage1: {
      ...
      treatment:
        "Stop ascent. Hydrate. Paracetamol. Monitor. Diamox 125mg if persists.",
    },
    stage2: {
      symptoms: ["Severe headache", "Vomiting", "SpO2 < 88%"],
      treatment:
        "Descend 500m immediately. O2 mask. Diamox 250mg. Satellite call to base.",
    },
    stage3: {
      symptoms: ["HACE/HAPE symptoms", "Unconsciousness", "SpO2 < 75%"],
      treatment:
        "Emergency O2. Dexamethasone/Nifedipine. Helicopter evacuation.",
    },
  },
  evacuationProcedure:
    "Garmin SOS → District Emergency Control → Helicopter from Phata or Badrinath helipad → CHC Joshimath or AIIMS Rishikesh.",
...
const doDhamBatches: BatchSlot[] = [
  ...
  },
  {
    ...
    guide: "Prakash Ramola",
    notes:
      "Navratri + Diwali — final closing season, maximum spiritual atmosphere",
  },
];

const doDhamReviews: Review[] = [
  {
    id: "dd-r1",
    author: "Santosh Iyer",
    rating: 5,
    ...
    title:
      "Kedarnath + Badrinath in 8 days — perfect balance of trek and pilgrimage",
    comment:
  ...
  },
  {
    ...
    comment:
      "We chose Do Dham for our honeymoon — unusual choice but the most meaningful trip we could imagine. The snowy Kedarnath approach in May, the ancient stone steps, the Shiva abhishek together — and then Badrinath with the Alaknanda River and the orange-yellow-white temple facade against the Nilkanth peak. Prakashji gave us privacy while ensuring our safety. The GMVN accommodation was upgraded for us. We'll return for Char Dham for our 10th anniversary.",
    date: "2024-05-30",
    month: 5,
    groupType: "couple",
    verified: true,
  ...
  },
  {
    ...
    title:
      "Outstanding value — way better organized than the 'budget' operators",
    comment:
...
// ─── MAIN YATRA DATA ARRAY ─────────────────────────────────────────────────────

export const yatraData: YatraDetail[] = [
  // ── 1. KEDARNATH YATRA ──────────────────────────────────────────────────────
  {
    id: "kedarnath-yatra",
    ...
    description:
      "Trek to the most sacred Jyotirlinga in the Himalayas — Lord Shiva's abode at 11,755ft. The 16km pilgrimage trail from Gaurikund winds through waterfalls, alpine meadows, and ancient stone steps to the 8th-century Kedarnath Temple, built (or restored) by Adi Shankaracharya. One of Hinduism's most revered pilgrimage destinations — a soul-stirring journey through the Mandakini River gorge to the land of Shiva.",
    overview:
      "Kedarnath Yatra is one of the most spiritually significant pilgrimages in India, combining a 16km high-altitude trek with one of Hinduism's most sacred temple visits. At 11,755ft, the grey stone Kedarnath Temple sits beneath the dramatic Kedarnath Peak (22,769ft) and the Chorabari Glacier — a setting of extraordinary natural and spiritual power. Global Trek provides full-service management: RFID registration, medical support at every checkpoint, government-certified guides with deep religious knowledge, puja booking, and helicopter coordination for elderly pilgrims.",
    quickFacts: {
      maxAltitudeZone: "High Alpine — Kedarnath Temple at 11,755ft (3,583m)",
      snowConditions:
        "Snow possible May–June on upper trail; clear September–October",
      trailType:
        "Paved stone steps (lower), rocky alpine path (upper), temple plaza",
      waterAvailability:
        "Abundant — Mandakini River, government taps, springs throughout",
      phoneNetwork:
        "BSNL and Jio at Gaurikund; BSNL only above 8,000ft; no signal at temple",
      permits:
        "RFID wristband mandatory (₹50) — included in package; Aadhaar required",
      fitness:
        "Walk 8–10 km with a daypack at moderate pace; no technical climbing",
      minAge: 10,
      maxAge: 70,
    },
    templeInfo: {
    ...
    darshan: [
      {
        ...
        description:
          "Sacred Rudrabhishek with milk, honey, ghee, and Gangajal. Limited to pre-registered pilgrims. Most spiritually powerful darshan of the day — garbhagriha access.",
      },
      {
        puja: "General Darshan",
        time: "7:00 AM – 12:00 PM",
        description:
          "Open to all RFID-registered pilgrims. Queue typically 1–4 hours depending on season. Exterior darshan and inner sanctum access permitted.",
      },
      {
        puja: "Sandhya Aarti (Evening Prayer)",
        time: "5:00 PM – 9:00 PM",
        description:
          "Evening prayer with oil lamps, flower offerings, and Sanskrit chanting. Deeply atmospheric — limited crowd post-4 PM. Temple beautifully illuminated.",
      },
    ],
    pujaOptions: [
      {
        ...
        duration: "45 minutes",
        bookingNote:
          "Pre-book 15+ days in advance. Priest chants Rudrashtadhyayi while performing milk, honey, ghee, and holy water abhishek.",
      },
      {
        name: "Sampoorna Puja",
        price: 5100,
        duration: "90 minutes",
        bookingNote:
          "Full puja including Rudrabhishek, 108 names of Shiva, and prasad. Pre-book 30+ days in advance for peak season.",
      },
      {
        ...
        duration: "3 hours",
        bookingNote:
          "Full VIP puja at garbhagriha — jal abhishek, flower offering, aarti, pandit guidance throughout. Available only through temple committee. Book 60+ days in advance.",
      },
    ],
    transportOptions: [
      {
        ...
        bookingNote:
          "The spiritually most rewarding mode. Well-paved 16km stone trail from Gaurikund with tea stalls and government rest points every 2–3 km.",
      },
      {
        ...
        duration: "8 minutes",
        bookingNote:
          "Book at IRCTC portal or Uttarakhand Tourism minimum 60 days in advance. Strictly weather-dependent — refund on cancellation. Elderly/disabled strongly advised.",
      },
      {
        ...
        duration: "6–7 hours",
        bookingNote:
          "Government-registered ponies and dolis (palanquins) available at Gaurikund. Best option for pilgrims with knee/hip conditions. Pre-book through guide.",
      },
    ],
    registrationSteps: [
      {
        step: 1,
        instruction:
          "Online registration at registrationandtouristcare.uk.gov.in — choose travel date, upload Aadhaar + passport photo. Receive unique registration ID (mandatory).",
      },
      {
        step: 2,
        instruction:
          "Collect RFID wristband at Rishikesh, Haridwar, Sonprayag, or Gaurikund check posts. ₹50 charge. Mandatory entry requirement — no RFID = no trek entry.",
      },
      {
        step: 3,
        instruction:
          "Medical screening: mandatory certificate for pilgrims above 50 years. Free government health posts at Sonprayag. ECG required above 60 years.",
      },
      {
        step: 4,
        instruction:
          "Begin trek from Gaurikund (6,503ft). RFID scan at entry gate. Government's time-stamped tracking system monitors your progress — emergency alerts if delayed.",
      },
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "May–June for fresh opening season and minimal crowds in early batches. September–October for post-monsoon clarity, best photography, and moderate temperatures. July–August is monsoon — trail is open but landslide risk is higher.",
      },
      {
        question: "How fit do I need to be for Kedarnath?",
        answer:
          "Moderate fitness is sufficient. You should be able to walk 8–10 km at a gentle pace over 6 hours. No technical climbing. However, altitude (11,755ft) is the real challenge — slow acclimatization pace and hydration are more important than aerobic fitness.",
      },
      {
        question: "Is Kedarnath safe for elderly pilgrims (65+)?",
        answer:
          "Yes, with proper preparation. We arrange medical screening, pony/helicopter for steep sections, and exclusive guide support for elderly pilgrims. ECG clearance required for 60+ years. Helicopter from Phata to temple (8 min) is highly recommended for cardiac/knee patients.",
      },
      {
        question: "When does the temple open and close in 2026?",
        answer:
          "Opening: April 22, 2026 (Akshaya Tritiya). Closing: November 5, 2026 (Bhai Dooj). The exact times are announced by the Badri-Kedar Temple Committee in the weeks before. Our earliest batch is May 10, 2026.",
      },
      {
        question: "Is pre-registration mandatory?",
        answer:
          "Yes — Uttarakhand government has made RFID registration mandatory for all Kedarnath pilgrims since 2014. Register at registrationandtouristcare.uk.gov.in with your Aadhaar. Our team assists with the complete process.",
      },
    ],
    packingList: [
  ...
  // ── 2. CHAR DHAM YATRA ──────────────────────────────────────────────────────
  {
    ...
    description:
      "The most sacred pilgrimage circuit in Hinduism — all four Himalayan Dhams in one journey. Yamunotri (origin of Yamuna River, 10,827ft), Gangotri (origin of Ganga, 10,200ft), Kedarnath (Shiva Jyotirlinga, 11,755ft), and Badrinath (Vishnu's seat, 10,279ft). Completing the Char Dham Yatra is believed to wash away all sins and grant moksha (liberation). Done anti-clockwise (West to East) as decreed by the Shastras.",
    overview:
      "Char Dham Yatra is the ultimate Hindu pilgrimage — visiting all four sacred Himalayan shrines in one 12-day journey. Global Trek's full-service package covers transportation, accommodation, all meals, certified guide, puja coordination, and complete medical support including satellite phone, oxygen cylinders, and emergency evacuation protocol. Our 22-year veteran guide Bhupendra Singh Negi has led 300+ complete Char Dham groups and knows each shrine's ritual calendar in detail.",
    quickFacts: {
      maxAltitudeZone:
        "High Alpine — 4 sacred Dhams between 10,200ft and 11,755ft",
      snowConditions:
        "Yamunotri: snow May–June. Gangotri: glacier year-round. Kedarnath: snow possible May–June, October",
      trailType:
        "Mix of road travel + Yamunotri trek (6km) + Kedarnath trek (16km) + Badrinath road",
      waterAvailability:
        "Hot springs at Yamunotri and Badrinath; river access throughout",
      phoneNetwork:
        "Connectivity varies — BSNL best. Satellite phone carried for all zones",
      permits:
        "RFID wristband (Kedarnath mandatory). Gangotri NP forest permit included",
      fitness:
        "Moderate — two significant treks (Yamunotri 6km, Kedarnath 16km). 12 days with rest days built in",
      minAge: 12,
      maxAge: 72,
    },
    templeInfo: {
      ...
      deity:
        "Yamuna Devi, Ganga Devi (Goddess Gangotri), Lord Shiva (Kedarnath), Lord Vishnu (Badrinath)",
      openingDate2026:
        "April 19–23, 2026 (Akshaya Tritiya week — all four Dhams)",
      closingDate2026:
        "October–November 2026 (varies per Dham; Kedarnath Nov 5)",
    ...
    darshan: [
      {
        ...
        description:
          "Cook rice/potatoes in the Surya Kund hot spring (traditional). Bathe in Janki Chatti hot kund. Visit the ancient Yamunotri temple. Yamuna origin spring is 1km beyond temple.",
      },
      {
        puja: "Gangotri Darshan",
        time: "6:15 AM – 2:00 PM, 3:00 PM – 9:30 PM",
        description:
          "Morning and evening aarti at Gangotri temple on the Bhagirathi banks. Optional Gaumukh glacier trek (19km extra) — actual source of the Ganga. Submerged Shivalinga at Bhagirathi.",
      },
      {
        puja: "Kedarnath Darshan + Abhishek",
        time: "4:00 AM – 9:00 PM",
        description:
          "Full Kedarnath protocol: 4 AM Pratah Puja, Rudrabhishek, afternoon general darshan, evening Sandhya Aarti. Adi Shankaracharya samadhi visit.",
      },
      {
        puja: "Badrinath Darshan + Maha Abhishek",
        time: "4:30 AM – 9:00 PM",
        description:
          "Badrinath Maha Abhishek puja (most important puja — offered since morning). Tapt Kund natural hot spring bath (mandatory before darshan). Brahma Kapal ghat for pitra tarpan (ancestor rituals).",
      },
    ],
    pujaOptions: [
      {
        ...
        duration: "45 minutes",
        bookingNote:
          "Includes priest-guided Shiva abhishek at Kedarnath garbhagriha.",
      },
      {
        ...
        duration: "60 minutes",
        bookingNote:
          "Full Vishnu Sahasranama puja at Badrinath. Pre-book 30 days in advance.",
      },
      {
        ...
        bookingNote:
          "Full puja at each Dham — guided by temple priests. Includes prasad, flowers, and puja samagri. Most popular choice.",
      },
    ],
    transportOptions: [
      {
        ...
        bookingNote:
          "Full-trip dedicated vehicle with experienced Garhwal mountain driver. AC available on plains sections.",
      },
      {
        ...
        bookingNote:
          "Strongly recommended for 65+ pilgrims or those with cardiac/knee conditions. Book separately through IRCTC portal.",
      },
    ],
    registrationSteps: [
      {
        step: 1,
        instruction:
          "Online registration at registrationandtouristcare.uk.gov.in for Kedarnath RFID (mandatory). Badrinath registration also recommended.",
      },
      {
        step: 2,
        instruction:
          "Medical certificate for pilgrims above 50 — ECG mandatory above 60 years. Our team arranges examination at Haridwar AIIMS health camp.",
      },
      {
        step: 3,
        instruction:
          "Collect RFID wristbands at Haridwar check post before departure. All verification done by Global Trek team.",
      },
      {
        step: 4,
        instruction:
          "Daily health check-in with guide throughout the yatra. Pulse oximetry at every high-altitude Dham.",
      },
    ],
    itinerary: [
      {
        ...
        description:
          "Arrival at Haridwar, RFID collection, group briefing, Ganga Aarti at Har Ki Pauri.",
        highlights: [
      ...
      },
      {
        ...
        description:
          "180km drive to Barkot (6,800ft) — Yamuna valley. Evening prayers at Hanuman Chatti.",
        highlights: [
      ...
      },
      {
        ...
        description:
          "6km trek to Yamunotri temple (10,827ft). Cook rice in Surya Kund hot spring. Evening descent.",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Drive 100km to Uttarkashi (4,921ft). Visit Vishwanath Temple, Nehru Institute of Mountaineering.",
        highlights: [
      ...
      },
      {
        ...
        description:
          "105km drive to Gangotri (10,200ft). Morning and evening aarti. Optional 6km walk toward Gaumukh glacier.",
        highlights: [
      ...
      },
      {
        ...
        description:
          "300km cross-mountain drive via Uttarkashi–Rishikesh–Rudraprayag to Guptkashi (4,757ft). Long but spectacular.",
        highlights: [
          "Rudraprayag sangam",
      ...
      },
      {
        ...
        description:
          "Drive Sonprayag (6,100ft), jeep to Gaurikund, trek 16km to Kedarnath (11,755ft).",
        highlights: [
      ...
      },
      {
        ...
        description:
          "4 AM Pratah Puja, full temple circuit, Adi Shankaracharya samadhi. Descend to Gaurikund.",
        highlights: [
          "4 AM Abhishek puja",
      ...
      },
      {
        ...
        description:
          "Drive 210km via Rudraprayag to Badrinath (10,279ft). Evening Badrinath aarti.",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Tapt Kund hot spring bath at sunrise, Maha Abhishek puja, Brahma Kapal ghat pitra tarpan, Mana village (last Indian village before Tibet border, 3km).",
        highlights: [
      ...
      },
      {
        ...
        description:
          "295km return drive to Rishikesh. Stop at Devprayag (Ganga origin sangam). Evening Ganga Aarti at Parmarth Niketan.",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Certificate of Char Dham completion distributed. Drop at Haridwar/Rishikesh railway station or airport.",
        highlights: [
    ...
    faqs: [
      {
        ...
        answer:
          "The Yamunotri trek (6km) and Kedarnath trek (16km) are the main physical challenges. The rest is comfortable road travel. Moderate fitness required. Elderly/unfit pilgrims can use helicopter for Kedarnath and pony/doli for Yamunotri.",
      },
      {
        question: "What is the sequence of Char Dham?",
        answer:
          "Anti-clockwise as per Shastra: Yamunotri → Gangotri → Kedarnath → Badrinath. Our itinerary strictly follows this sequence.",
      },
      {
        question: "When do the Char Dhams open in 2026?",
        answer:
          "All four Dhams open in April 2026 during Akshaya Tritiya week (April 19–23). Our first batch departs May 5, 2026.",
      },
    ],
    packingList: [
  ...
  // ── 3. DO DHAM YATRA (BADRINATH + KEDARNATH) ────────────────────────────────
  {
    ...
    templeInfo: {
      ...
      openingDate2026:
        "April 22, 2026 (Kedarnath) / April 23, 2026 (Badrinath)",
      closingDate2026:
        "November 5, 2026 (Kedarnath) / November 17–20, 2026 (Badrinath)",
      committeePhone: "+91-1389-222228",
      registrationLink: "https://registrationandtouristcare.uk.gov.in",
    },
    darshan: [
      {
        ...
        time: "4:00 AM – 7:00 AM",
        description:
          "Pre-registered pilgrims only. Rudrabhishek with milk, ghee, honey, Gangajal. Most powerful darshan slot. Priest-guided puja at garbhagriha.",
      },
      {
        puja: "Badrinath Maha Abhishek",
        time: "4:30 AM – 6:30 AM",
        description:
          "Supreme Vishnu puja — offered by hereditary Rawal (head priest from Kerala) tradition since 8th century. Tapt Kund bath precedes darshan.",
      },
      {
        puja: "Badrinath Evening Aarti",
        time: "8:00 PM – 9:00 PM",
        description:
          "Deeply atmospheric evening aarti with lamps, flowers, and Vishnu Sahasranama chanting. Best darshan time for photography (exterior only).",
      },
    ],
    pujaOptions: [
      {
        ...
        duration: "45 minutes",
        bookingNote:
          "Pre-book 15+ days in advance. Full Shiva abhishek at Kedarnath.",
      },
      {
        name: "Badrinath Maha Abhishek",
        price: 4500,
        duration: "60 minutes",
        bookingNote:
          "Full Vishnu Sahasranama puja. Pre-book 30 days in advance for peak season.",
      },
      {
        ...
        bookingNote:
          "Combined puja package for both Dhams — best value. Includes prasad and guide.",
      },
    ],
    transportOptions: [
      {
        ...
        bookingNote:
          "Dedicated vehicle for all 8 days with experienced Garhwal mountain driver.",
      },
      {
        option: "Helicopter for Kedarnath",
        ...
        duration: "8 minutes from Phata",
        bookingNote:
          "Recommended for elderly/unfit pilgrims. Book separately through IRCTC.",
      },
    ],
    registrationSteps: [
      {
        step: 1,
        instruction:
          "Register online at registrationandtouristcare.uk.gov.in for Kedarnath RFID wristband. Mandatory. Our team assists.",
      },
      {
        step: 2,
        instruction:
          "Medical clearance for 60+ years — ECG and fitness certificate from registered doctor. Free health check at Haridwar AIIMS camp.",
      },
      {
        step: 3,
        instruction:
          "RFID wristband collection at Haridwar on Day 1. Global Trek team manages all verification.",
      },
      {
        step: 4,
        instruction:
          "Daily SpO2 monitoring from Kedarnath day onwards. Morning health briefing throughout.",
      },
    ],
    itinerary: [
      {
        ...
        title: "Arrive Haridwar",
        description:
          "Group meeting at Haridwar. RFID collection, briefing, Ganga Aarti.",
        highlights: [
          "Group meeting",
          "RFID wristband collection",
          "Ganga Aarti at Har Ki Pauri",
      ...
      },
      {
        ...
        description:
          "240km drive to Guptkashi (4,757ft) — Kedarnath base zone. Vishwanath temple visit.",
        highlights: [
          "Rudraprayag sangam",
      ...
      },
      {
        ...
        description:
          "Jeep to Gaurikund, 16km trek to Kedarnath (11,755ft). Evening Sandhya Aarti.",
        highlights: [
      ...
      },
      {
        ...
        title: "Kedarnath Darshan & Descent",
        description:
          "4 AM Abhishek puja. Full temple circuit. Descent to Gaurikund.",
        highlights: [
          "4 AM Rudrabhishek",
      ...
      },
      {
        ...
        title: "Gaurikund → Badrinath",
        description:
          "210km drive via Rudraprayag to Badrinath (10,279ft). Evening aarti.",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Tapt Kund sunrise bath, Maha Abhishek, Brahma Kapal ghat, Mana village (last Indian village).",
        highlights: [
      ...
      },
      {
        ...
        title: "Badrinath → Rishikesh",
        description:
          "295km return drive to Rishikesh. Devprayag stop. Evening Ganga Aarti.",
        highlights: [
      ...
      },
      {
        ...
        title: "Rishikesh → Haridwar Departure",
        description:
          "Completion certificate distributed. Drop at Haridwar/Rishikesh railway station.",
        highlights: [
          "Completion certificate",
    ...
    faqs: [
      {
        ...
        answer:
          "Do Dham is ideal for first-time Himalayan pilgrims, those with limited time (8 days), or those who want a focused Shiva + Vishnu experience. Char Dham (12 days) is the complete moksha circuit. Many pilgrims do Do Dham first, then return for Char Dham.",
      },
      {
        question: "Can elderly parents do Badrinath without trekking?",
        answer:
          "Yes — Badrinath is fully accessible by road up to the temple gate. Only Kedarnath requires a 16km trek (or helicopter). Helicopter from Phata to Kedarnath (8 min) is the solution for elderly/unfit pilgrims.",
      },
    ],
    packingList: [
...
export function getYatraBySlug(slug: string): YatraDetail | undefined {
  return yatraData.find((y) => y.slug === slug || y.id === slug);
}

export function getAllYatras(): YatraDetail[] {
  return yatraData;
}

export default yatraData;
